...
#[doc = "OTP_READ_CTRL (rw) register accessor: OTP read start register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`otp_read_ctrl::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`otp_read_ctrl::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@otp_read_ctrl`]
module"]
...
#[doc = "OTP_READ_DATA (r) register accessor: OTP read data register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`otp_read_data::R`].  See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@otp_read_data`]
module"]
...
#[doc = "OTP_CLK_DIV (rw) register accessor: OTP clock divider register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`otp_clk_div::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`otp_clk_div::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@otp_clk_div`]
module"]
#[doc(alias = "OTP_CLK_DIV")]
pub type OtpClkDiv = crate::Reg<otp_clk_div::OtpClkDivSpec>;
#[doc = "OTP clock divider register"]
pub mod otp_clk_div;
#[doc = "OTP_CRC_ADDR (rw) register accessor: CRC address range register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`otp_crc_addr::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`otp_crc_addr::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@otp_crc_addr`]
module"]
...
#[doc = "OTP_CRC_VALUE (rw) register accessor: CRC result register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`otp_crc_value::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`otp_crc_value::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@otp_crc_value`]
module"]
...
#[doc = "OTP_STATUS (rw) register accessor: Status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`otp_status::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`otp_status::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@otp_status`]
module"]
#[doc(alias = "OTP_STATUS")]
pub type OtpStatus = crate::Reg<otp_status::OtpStatusSpec>;
#[doc = "Status register"]
pub mod otp_status;
#[doc = "OTP_VERSION (r) register accessor: VERSION ID register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`otp_version::R`].  See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@otp_version`]
module"]
