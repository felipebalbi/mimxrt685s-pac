...
#[doc = "W_ (rw) register accessor: Word pin registers for all port 0 and 1 GPIO pins\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`w_::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`w_::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@w_`]
module"]
