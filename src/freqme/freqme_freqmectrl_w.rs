...
pub type W = crate::W<FreqmeFreqmectrlWSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ref_scale(&mut self) -> RefScaleW<FreqmeFreqmectrlWSpec> {
        RefScaleW::new(self, 0)
    }
    #[doc = "Bit 8 - Pulse Width Measurement mode select"]
    #[inline(always)]
    #[must_use]
    pub fn pulse_mode(&mut self) -> PulseModeW<FreqmeFreqmectrlWSpec> {
        PulseModeW::new(self, 8)
    }
    #[doc = "Bit 9 - Pulse Polarity"]
    #[inline(always)]
    #[must_use]
    pub fn pulse_pol(&mut self) -> PulsePolW<FreqmeFreqmectrlWSpec> {
        PulsePolW::new(self, 9)
    }
    #[doc = "Bit 31 - Measure in Progress"]
    #[inline(always)]
    #[must_use]
    pub fn measure_in_progress(&mut self) -> MeasureInProgressW<FreqmeFreqmectrlWSpec> {
...
impl crate::Writable for FreqmeFreqmectrlWSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FREQMECTRL_W to value 0"]
impl crate::Resettable for FreqmeFreqmectrlWSpec {
