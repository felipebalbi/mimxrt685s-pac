#[doc = "Register `PIO7_11` reader"]
pub type R = crate::R<Pio7_11Spec>;
#[doc = "Register `PIO7_11` writer"]
pub type W = crate::W<Pio7_11Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fsel(&mut self) -> FselW<Pio7_11Spec> {
        FselW::new(self, 0)
    }
    #[doc = "Bit 4 - Pullup / Pulldown Enable. . ."]
    #[inline(always)]
    #[must_use]
    pub fn pupdena(&mut self) -> PupdenaW<Pio7_11Spec> {
        PupdenaW::new(self, 4)
    }
    #[doc = "Bit 5 - Pullup or Pulldown Selector. . ."]
    #[inline(always)]
    #[must_use]
    pub fn pupdsel(&mut self) -> PupdselW<Pio7_11Spec> {
        PupdselW::new(self, 5)
    }
    #[doc = "Bit 6 - Input Buffer Enable. ."]
    #[inline(always)]
    #[must_use]
    pub fn ibena(&mut self) -> IbenaW<Pio7_11Spec> {
        IbenaW::new(self, 6)
    }
    #[doc = "Bit 7 - Slew Rate Control. . ."]
    #[inline(always)]
    #[must_use]
    pub fn slewrate(&mut self) -> SlewrateW<Pio7_11Spec> {
        SlewrateW::new(self, 7)
    }
    #[doc = "Bit 8 - Drive Selector. . ."]
    #[inline(always)]
    #[must_use]
    pub fn fulldrive(&mut self) -> FulldriveW<Pio7_11Spec> {
        FulldriveW::new(self, 8)
    }
    #[doc = "Bit 9 - Analog Mux Enable. . ."]
    #[inline(always)]
    #[must_use]
    pub fn amena(&mut self) -> AmenaW<Pio7_11Spec> {
        AmenaW::new(self, 9)
    }
    #[doc = "Bit 10 - Pseudo Output Drain Enable. . ."]
    #[inline(always)]
    #[must_use]
    pub fn odena(&mut self) -> OdenaW<Pio7_11Spec> {
        OdenaW::new(self, 10)
    }
    #[doc = "Bit 11 - Input Invert Enable. . ."]
    #[inline(always)]
    #[must_use]
    pub fn iiena(&mut self) -> IienaW<Pio7_11Spec> {
        IienaW::new(self, 11)
    }
}
#[doc = "iop pad control register for port0 to port5\n\nYou can [`read`](crate::Reg::read) this register and get [`pio7_11::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pio7_11::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pio7_11Spec;
impl crate::RegisterSpec for Pio7_11Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pio7_11::R`](R) reader structure"]
impl crate::Readable for Pio7_11Spec {}
#[doc = "`write(|w| ..)` method takes [`pio7_11::W`](W) writer structure"]
impl crate::Writable for Pio7_11Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PIO7_11 to value 0"]
impl crate::Resettable for Pio7_11Spec {
