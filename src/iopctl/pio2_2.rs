...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fsel(&mut self) -> FselW<Pio2_2Spec> {
        FselW::new(self, 0)
    }
    #[doc = "Bit 4 - Pullup / Pulldown Enable. . ."]
    #[inline(always)]
    #[must_use]
    pub fn pupdena(&mut self) -> PupdenaW<Pio2_2Spec> {
        PupdenaW::new(self, 4)
    }
    #[doc = "Bit 5 - Pullup or Pulldown Selector. . ."]
    #[inline(always)]
    #[must_use]
    pub fn pupdsel(&mut self) -> PupdselW<Pio2_2Spec> {
        PupdselW::new(self, 5)
    }
    #[doc = "Bit 6 - Input Buffer Enable. ."]
    #[inline(always)]
    #[must_use]
    pub fn ibena(&mut self) -> IbenaW<Pio2_2Spec> {
        IbenaW::new(self, 6)
    }
    #[doc = "Bit 7 - Slew Rate Control. . ."]
    #[inline(always)]
    #[must_use]
    pub fn slewrate(&mut self) -> SlewrateW<Pio2_2Spec> {
        SlewrateW::new(self, 7)
    }
    #[doc = "Bit 8 - Drive Selector. . ."]
    #[inline(always)]
    #[must_use]
    pub fn fulldrive(&mut self) -> FulldriveW<Pio2_2Spec> {
        FulldriveW::new(self, 8)
    }
    #[doc = "Bit 9 - Analog Mux Enable. . ."]
    #[inline(always)]
    #[must_use]
    pub fn amena(&mut self) -> AmenaW<Pio2_2Spec> {
        AmenaW::new(self, 9)
    }
    #[doc = "Bit 10 - Pseudo Output Drain Enable. . ."]
    #[inline(always)]
    #[must_use]
    pub fn odena(&mut self) -> OdenaW<Pio2_2Spec> {
        OdenaW::new(self, 10)
    }
    #[doc = "Bit 11 - Input Invert Enable. . ."]
    #[inline(always)]
    #[must_use]
    pub fn iiena(&mut self) -> IienaW<Pio2_2Spec> {
        IienaW::new(self, 11)
    }
}
#[doc = "iop pad control register for port0 to port5\n\nYou can [`read`](crate::Reg::read) this register and get [`pio2_2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pio2_2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets PIO2_2 to value 0"]
