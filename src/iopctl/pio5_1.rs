#[doc = "Register `PIO5_1` reader"]
pub type R = crate::R<Pio5_1Spec>;
#[doc = "Register `PIO5_1` writer"]
pub type W = crate::W<Pio5_1Spec>;
...
impl W {
    #[doc = "Bits 0:3 - Function Selector. . .(FSELs Sources can be found in the next several pages.)"]
    #[inline(always)]
    pub fn fsel(&mut self) -> FselW<Pio5_1Spec> {
        FselW::new(self, 0)
    }
    #[doc = "Bit 4 - Pullup / Pulldown Enable. . ."]
    #[inline(always)]
    pub fn pupdena(&mut self) -> PupdenaW<Pio5_1Spec> {
        PupdenaW::new(self, 4)
    }
    #[doc = "Bit 5 - Pullup or Pulldown Selector. . ."]
    #[inline(always)]
    pub fn pupdsel(&mut self) -> PupdselW<Pio5_1Spec> {
        PupdselW::new(self, 5)
    }
    #[doc = "Bit 6 - Input Buffer Enable. ."]
    #[inline(always)]
    pub fn ibena(&mut self) -> IbenaW<Pio5_1Spec> {
        IbenaW::new(self, 6)
    }
    #[doc = "Bit 7 - Slew Rate Control. . ."]
    #[inline(always)]
    pub fn slewrate(&mut self) -> SlewrateW<Pio5_1Spec> {
        SlewrateW::new(self, 7)
    }
    #[doc = "Bit 8 - Drive Selector. . ."]
    #[inline(always)]
    pub fn fulldrive(&mut self) -> FulldriveW<Pio5_1Spec> {
        FulldriveW::new(self, 8)
    }
    #[doc = "Bit 9 - Analog Mux Enable. . ."]
    #[inline(always)]
    pub fn amena(&mut self) -> AmenaW<Pio5_1Spec> {
        AmenaW::new(self, 9)
    }
    #[doc = "Bit 10 - Pseudo Output Drain Enable. . ."]
    #[inline(always)]
    pub fn odena(&mut self) -> OdenaW<Pio5_1Spec> {
        OdenaW::new(self, 10)
    }
    #[doc = "Bit 11 - Input Invert Enable. . ."]
    #[inline(always)]
    pub fn iiena(&mut self) -> IienaW<Pio5_1Spec> {
        IienaW::new(self, 11)
    }
}
#[doc = "iop pad control register for port0 to port5\n\nYou can [`read`](crate::Reg::read) this register and get [`pio5_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pio5_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pio5_1Spec;
impl crate::RegisterSpec for Pio5_1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pio5_1::R`](R) reader structure"]
impl crate::Readable for Pio5_1Spec {}
#[doc = "`write(|w| ..)` method takes [`pio5_1::W`](W) writer structure"]
impl crate::Writable for Pio5_1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PIO5_1 to value 0"]
impl crate::Resettable for Pio5_1Spec {
