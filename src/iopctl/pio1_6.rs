...
impl W {
    #[doc = "Bits 0:3 - Function Selector. . .(FSELs Sources can be found in the next several pages.)"]
    #[inline(always)]
    pub fn fsel(&mut self) -> FselW<Pio1_6Spec> {
        FselW::new(self, 0)
    }
    #[doc = "Bit 4 - Pullup / Pulldown Enable. . ."]
    #[inline(always)]
    pub fn pupdena(&mut self) -> PupdenaW<Pio1_6Spec> {
        PupdenaW::new(self, 4)
    }
    #[doc = "Bit 5 - Pullup or Pulldown Selector. . ."]
    #[inline(always)]
    pub fn pupdsel(&mut self) -> PupdselW<Pio1_6Spec> {
        PupdselW::new(self, 5)
    }
    #[doc = "Bit 6 - Input Buffer Enable. ."]
    #[inline(always)]
    pub fn ibena(&mut self) -> IbenaW<Pio1_6Spec> {
        IbenaW::new(self, 6)
    }
    #[doc = "Bit 7 - Slew Rate Control. . ."]
    #[inline(always)]
    pub fn slewrate(&mut self) -> SlewrateW<Pio1_6Spec> {
        SlewrateW::new(self, 7)
    }
    #[doc = "Bit 8 - Drive Selector. . ."]
    #[inline(always)]
    pub fn fulldrive(&mut self) -> FulldriveW<Pio1_6Spec> {
        FulldriveW::new(self, 8)
    }
    #[doc = "Bit 9 - Analog Mux Enable. . ."]
    #[inline(always)]
    pub fn amena(&mut self) -> AmenaW<Pio1_6Spec> {
        AmenaW::new(self, 9)
    }
    #[doc = "Bit 10 - Pseudo Output Drain Enable. . ."]
    #[inline(always)]
    pub fn odena(&mut self) -> OdenaW<Pio1_6Spec> {
        OdenaW::new(self, 10)
    }
    #[doc = "Bit 11 - Input Invert Enable. . ."]
    #[inline(always)]
    pub fn iiena(&mut self) -> IienaW<Pio1_6Spec> {
        IienaW::new(self, 11)
    }
}
