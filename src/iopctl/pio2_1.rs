...
impl W {
    #[doc = "Bits 0:3 - Function Selector. . .(FSELs Sources can be found in the next several pages.)"]
    #[inline(always)]
    pub fn fsel(&mut self) -> FselW<Pio2_1Spec> {
        FselW::new(self, 0)
    }
    #[doc = "Bit 4 - Pullup / Pulldown Enable. . ."]
    #[inline(always)]
    pub fn pupdena(&mut self) -> PupdenaW<Pio2_1Spec> {
        PupdenaW::new(self, 4)
    }
    #[doc = "Bit 5 - Pullup or Pulldown Selector. . ."]
    #[inline(always)]
    pub fn pupdsel(&mut self) -> PupdselW<Pio2_1Spec> {
        PupdselW::new(self, 5)
    }
    #[doc = "Bit 6 - Input Buffer Enable. ."]
    #[inline(always)]
    pub fn ibena(&mut self) -> IbenaW<Pio2_1Spec> {
        IbenaW::new(self, 6)
    }
    #[doc = "Bit 7 - Slew Rate Control. . ."]
    #[inline(always)]
    pub fn slewrate(&mut self) -> SlewrateW<Pio2_1Spec> {
        SlewrateW::new(self, 7)
    }
    #[doc = "Bit 8 - Drive Selector. . ."]
    #[inline(always)]
    pub fn fulldrive(&mut self) -> FulldriveW<Pio2_1Spec> {
        FulldriveW::new(self, 8)
    }
    #[doc = "Bit 9 - Analog Mux Enable. . ."]
    #[inline(always)]
    pub fn amena(&mut self) -> AmenaW<Pio2_1Spec> {
        AmenaW::new(self, 9)
    }
    #[doc = "Bit 10 - Pseudo Output Drain Enable. . ."]
    #[inline(always)]
    pub fn odena(&mut self) -> OdenaW<Pio2_1Spec> {
        OdenaW::new(self, 10)
    }
    #[doc = "Bit 11 - Input Invert Enable. . ."]
    #[inline(always)]
    pub fn iiena(&mut self) -> IienaW<Pio2_1Spec> {
        IienaW::new(self, 11)
    }
}
#[doc = "iop pad control register for port0 to port5\n\nYou can [`read`](crate::Reg::read) this register and get [`pio2_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pio2_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets PIO2_1 to value 0"]
