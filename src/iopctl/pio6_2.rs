#[doc = "Register `PIO6_2` reader"]
pub type R = crate::R<Pio6_2Spec>;
#[doc = "Register `PIO6_2` writer"]
pub type W = crate::W<Pio6_2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fsel(&mut self) -> FselW<Pio6_2Spec> {
        FselW::new(self, 0)
    }
    #[doc = "Bit 4 - Pullup / Pulldown Enable. . ."]
    #[inline(always)]
    #[must_use]
    pub fn pupdena(&mut self) -> PupdenaW<Pio6_2Spec> {
        PupdenaW::new(self, 4)
    }
    #[doc = "Bit 5 - Pullup or Pulldown Selector. . ."]
    #[inline(always)]
    #[must_use]
    pub fn pupdsel(&mut self) -> PupdselW<Pio6_2Spec> {
        PupdselW::new(self, 5)
    }
    #[doc = "Bit 6 - Input Buffer Enable. ."]
    #[inline(always)]
    #[must_use]
    pub fn ibena(&mut self) -> IbenaW<Pio6_2Spec> {
        IbenaW::new(self, 6)
    }
    #[doc = "Bit 7 - Slew Rate Control. . ."]
    #[inline(always)]
    #[must_use]
    pub fn slewrate(&mut self) -> SlewrateW<Pio6_2Spec> {
        SlewrateW::new(self, 7)
    }
    #[doc = "Bit 8 - Drive Selector. . ."]
    #[inline(always)]
    #[must_use]
    pub fn fulldrive(&mut self) -> FulldriveW<Pio6_2Spec> {
        FulldriveW::new(self, 8)
    }
    #[doc = "Bit 9 - Analog Mux Enable. . ."]
    #[inline(always)]
    #[must_use]
    pub fn amena(&mut self) -> AmenaW<Pio6_2Spec> {
        AmenaW::new(self, 9)
    }
    #[doc = "Bit 10 - Pseudo Output Drain Enable. . ."]
    #[inline(always)]
    #[must_use]
    pub fn odena(&mut self) -> OdenaW<Pio6_2Spec> {
        OdenaW::new(self, 10)
    }
    #[doc = "Bit 11 - Input Invert Enable. . ."]
    #[inline(always)]
    #[must_use]
    pub fn iiena(&mut self) -> IienaW<Pio6_2Spec> {
        IienaW::new(self, 11)
    }
}
#[doc = "iop pad control register for port0 to port5\n\nYou can [`read`](crate::Reg::read) this register and get [`pio6_2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pio6_2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pio6_2Spec;
impl crate::RegisterSpec for Pio6_2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pio6_2::R`](R) reader structure"]
impl crate::Readable for Pio6_2Spec {}
#[doc = "`write(|w| ..)` method takes [`pio6_2::W`](W) writer structure"]
impl crate::Writable for Pio6_2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PIO6_2 to value 0"]
impl crate::Resettable for Pio6_2Spec {
