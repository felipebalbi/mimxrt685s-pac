#[doc = "Register `PIO7_1` reader"]
pub type R = crate::R<Pio7_1Spec>;
#[doc = "Register `PIO7_1` writer"]
pub type W = crate::W<Pio7_1Spec>;
...
#[doc = "iop pad control register for port0 to port5\n\nYou can [`read`](crate::Reg::read) this register and get [`pio7_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pio7_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pio7_1Spec;
impl crate::RegisterSpec for Pio7_1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pio7_1::R`](R) reader structure"]
impl crate::Readable for Pio7_1Spec {}
#[doc = "`write(|w| ..)` method takes [`pio7_1::W`](W) writer structure"]
impl crate::Writable for Pio7_1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PIO7_1 to value 0"]
impl crate::Resettable for Pio7_1Spec {
