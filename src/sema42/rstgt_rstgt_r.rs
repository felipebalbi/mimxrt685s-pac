...
pub type R = crate::R<RstgtRstgtRSpec>;
...
#[doc = "Reset Gate Read\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rstgt_rstgt_r::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RstgtRstgtRSpec;
impl crate::RegisterSpec for RstgtRstgtRSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`rstgt_rstgt_r::R`](R) reader structure"]
impl crate::Readable for RstgtRstgtRSpec {}
#[doc = "`reset()` method sets RSTGT_R to value 0"]
impl crate::Resettable for RstgtRstgtRSpec {
