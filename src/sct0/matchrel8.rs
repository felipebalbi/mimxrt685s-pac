...
pub type R = crate::R<Matchrel8Spec>;
#[doc = "Register `MATCHREL8` writer"]
pub type W = crate::W<Matchrel8Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reloadn_l(&mut self) -> ReloadnLW<Matchrel8Spec> {
        ReloadnLW::new(self, 0)
    }
    #[doc = "Bits 16:31 - When UNIFY = 0, specifies the 16-bit to be loaded into the MATCHn_H register. When UNIFY = 1, specifies the upper 16 bits of the 32-bit value to be loaded into the MATCHn register."]
    #[inline(always)]
    #[must_use]
    pub fn reloadn_h(&mut self) -> ReloadnHW<Matchrel8Spec> {
        ReloadnHW::new(self, 16)
    }
}
#[doc = "SCT match reload value register\n\nYou can [`read`](crate::Reg::read) this register and get [`matchrel8::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`matchrel8::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Matchrel8Spec;
impl crate::RegisterSpec for Matchrel8Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`matchrel8::R`](R) reader structure"]
impl crate::Readable for Matchrel8Spec {}
#[doc = "`write(|w| ..)` method takes [`matchrel8::W`](W) writer structure"]
impl crate::Writable for Matchrel8Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MATCHREL8 to value 0"]
impl crate::Resettable for Matchrel8Spec {
