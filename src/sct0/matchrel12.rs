...
pub type R = crate::R<Matchrel12Spec>;
#[doc = "Register `MATCHREL12` writer"]
pub type W = crate::W<Matchrel12Spec>;
...
#[doc = "SCT match reload value register\n\nYou can [`read`](crate::Reg::read) this register and get [`matchrel12::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`matchrel12::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Matchrel12Spec;
impl crate::RegisterSpec for Matchrel12Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`matchrel12::R`](R) reader structure"]
impl crate::Readable for Matchrel12Spec {}
#[doc = "`write(|w| ..)` method takes [`matchrel12::W`](W) writer structure"]
impl crate::Writable for Matchrel12Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MATCHREL12 to value 0"]
impl crate::Resettable for Matchrel12Spec {
