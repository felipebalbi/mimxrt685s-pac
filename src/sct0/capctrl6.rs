...
pub type R = crate::R<Capctrl6Spec>;
#[doc = "Register `CAPCTRL6` writer"]
pub type W = crate::W<Capctrl6Spec>;
...
impl W {
    #[doc = "Bits 0:15 - If bit m is one, event m causes the CAPn_L (UNIFY = 0) or the CAPn (UNIFY = 1) register to be loaded (event 0 = bit 0, event 1 = bit 1, etc.). The number of bits = number of match/captures in this SCT."]
    #[inline(always)]
    pub fn capconn_l(&mut self) -> CapconnLW<Capctrl6Spec> {
        CapconnLW::new(self, 0)
    }
    #[doc = "Bits 16:31 - If bit m is one, event m causes the CAPn_H (UNIFY = 0) register to be loaded (event 0 = bit 16, event 1 = bit 17, etc.). The number of bits = number of match/captures in this SCT."]
    #[inline(always)]
    pub fn capconn_h(&mut self) -> CapconnHW<Capctrl6Spec> {
        CapconnHW::new(self, 16)
    }
}
#[doc = "SCT capture control register\n\nYou can [`read`](crate::Reg::read) this register and get [`capctrl6::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`capctrl6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Capctrl6Spec;
impl crate::RegisterSpec for Capctrl6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`capctrl6::R`](R) reader structure"]
impl crate::Readable for Capctrl6Spec {}
#[doc = "`write(|w| ..)` method takes [`capctrl6::W`](W) writer structure"]
impl crate::Writable for Capctrl6Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CAPCTRL6 to value 0"]
impl crate::Resettable for Capctrl6Spec {
