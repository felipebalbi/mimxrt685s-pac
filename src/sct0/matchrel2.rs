...
pub type R = crate::R<Matchrel2Spec>;
#[doc = "Register `MATCHREL2` writer"]
pub type W = crate::W<Matchrel2Spec>;
...
impl W {
    #[doc = "Bits 0:15 - When UNIFY = 0, specifies the 16-bit value to be loaded into the MATCHn_L register. When UNIFY = 1, specifies the lower 16 bits of the 32-bit value to be loaded into the MATCHn register."]
    #[inline(always)]
    pub fn reloadn_l(&mut self) -> ReloadnLW<Matchrel2Spec> {
        ReloadnLW::new(self, 0)
    }
    #[doc = "Bits 16:31 - When UNIFY = 0, specifies the 16-bit to be loaded into the MATCHn_H register. When UNIFY = 1, specifies the upper 16 bits of the 32-bit value to be loaded into the MATCHn register."]
    #[inline(always)]
    pub fn reloadn_h(&mut self) -> ReloadnHW<Matchrel2Spec> {
        ReloadnHW::new(self, 16)
    }
}
#[doc = "SCT match reload value register\n\nYou can [`read`](crate::Reg::read) this register and get [`matchrel2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`matchrel2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Matchrel2Spec;
impl crate::RegisterSpec for Matchrel2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`matchrel2::R`](R) reader structure"]
impl crate::Readable for Matchrel2Spec {}
#[doc = "`write(|w| ..)` method takes [`matchrel2::W`](W) writer structure"]
impl crate::Writable for Matchrel2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MATCHREL2 to value 0"]
impl crate::Resettable for Matchrel2Spec {
