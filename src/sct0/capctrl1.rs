...
pub type R = crate::R<Capctrl1Spec>;
#[doc = "Register `CAPCTRL1` writer"]
pub type W = crate::W<Capctrl1Spec>;
...
impl W {
    #[doc = "Bits 0:15 - If bit m is one, event m causes the CAPn_L (UNIFY = 0) or the CAPn (UNIFY = 1) register to be loaded (event 0 = bit 0, event 1 = bit 1, etc.). The number of bits = number of match/captures in this SCT."]
    #[inline(always)]
    pub fn capconn_l(&mut self) -> CapconnLW<Capctrl1Spec> {
        CapconnLW::new(self, 0)
    }
    #[doc = "Bits 16:31 - If bit m is one, event m causes the CAPn_H (UNIFY = 0) register to be loaded (event 0 = bit 16, event 1 = bit 17, etc.). The number of bits = number of match/captures in this SCT."]
    #[inline(always)]
    pub fn capconn_h(&mut self) -> CapconnHW<Capctrl1Spec> {
        CapconnHW::new(self, 16)
    }
}
#[doc = "SCT capture control register\n\nYou can [`read`](crate::Reg::read) this register and get [`capctrl1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`capctrl1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Capctrl1Spec;
impl crate::RegisterSpec for Capctrl1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`capctrl1::R`](R) reader structure"]
impl crate::Readable for Capctrl1Spec {}
#[doc = "`write(|w| ..)` method takes [`capctrl1::W`](W) writer structure"]
impl crate::Writable for Capctrl1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CAPCTRL1 to value 0"]
impl crate::Resettable for Capctrl1Spec {
