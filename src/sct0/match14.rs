...
pub type R = crate::R<Match14Spec>;
#[doc = "Register `MATCH14` writer"]
pub type W = crate::W<Match14Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn matchn_l(&mut self) -> MatchnLW<Match14Spec> {
        MatchnLW::new(self, 0)
    }
    #[doc = "Bits 16:31 - When UNIFY = 0, read or write the 16-bit value to be compared to the H counter. When UNIFY = 1, read or write the upper 16 bits of the 32-bit value to be compared to the unified counter."]
    #[inline(always)]
    #[must_use]
    pub fn matchn_h(&mut self) -> MatchnHW<Match14Spec> {
        MatchnHW::new(self, 16)
    }
}
#[doc = "SCT match value register of match channels\n\nYou can [`read`](crate::Reg::read) this register and get [`match14::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`match14::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Match14Spec;
impl crate::RegisterSpec for Match14Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`match14::R`](R) reader structure"]
impl crate::Readable for Match14Spec {}
#[doc = "`write(|w| ..)` method takes [`match14::W`](W) writer structure"]
impl crate::Writable for Match14Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MATCH14 to value 0"]
impl crate::Resettable for Match14Spec {
