...
pub type R = crate::R<Cap14Spec>;
#[doc = "Register `CAP14` writer"]
pub type W = crate::W<Cap14Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn capn_l(&mut self) -> CapnLW<Cap14Spec> {
        CapnLW::new(self, 0)
    }
    #[doc = "Bits 16:31 - When UNIFY = 0, read the 16-bit counter value at which this register was last captured. When UNIFY = 1, read the upper 16 bits of the 32-bit value at which this register was last captured."]
    #[inline(always)]
    #[must_use]
    pub fn capn_h(&mut self) -> CapnHW<Cap14Spec> {
        CapnHW::new(self, 16)
    }
}
#[doc = "SCT capture register of capture channel\n\nYou can [`read`](crate::Reg::read) this register and get [`cap14::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cap14::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cap14Spec;
impl crate::RegisterSpec for Cap14Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cap14::R`](R) reader structure"]
impl crate::Readable for Cap14Spec {}
#[doc = "`write(|w| ..)` method takes [`cap14::W`](W) writer structure"]
impl crate::Writable for Cap14Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CAP14 to value 0"]
impl crate::Resettable for Cap14Spec {
