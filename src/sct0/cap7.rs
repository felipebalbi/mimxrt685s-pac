...
pub type R = crate::R<Cap7Spec>;
#[doc = "Register `CAP7` writer"]
pub type W = crate::W<Cap7Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn capn_l(&mut self) -> CapnLW<Cap7Spec> {
        CapnLW::new(self, 0)
    }
    #[doc = "Bits 16:31 - When UNIFY = 0, read the 16-bit counter value at which this register was last captured. When UNIFY = 1, read the upper 16 bits of the 32-bit value at which this register was last captured."]
    #[inline(always)]
    #[must_use]
    pub fn capn_h(&mut self) -> CapnHW<Cap7Spec> {
        CapnHW::new(self, 16)
    }
}
#[doc = "SCT capture register of capture channel\n\nYou can [`read`](crate::Reg::read) this register and get [`cap7::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cap7::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cap7Spec;
impl crate::RegisterSpec for Cap7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cap7::R`](R) reader structure"]
impl crate::Readable for Cap7Spec {}
#[doc = "`write(|w| ..)` method takes [`cap7::W`](W) writer structure"]
impl crate::Writable for Cap7Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CAP7 to value 0"]
impl crate::Resettable for Cap7Spec {
