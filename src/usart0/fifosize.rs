...
#[doc = "Field `FIFOSIZE` reader - the fifo size is equal to the template parameter \"fifo\"."]
pub type FifosizeR = crate::FieldReader;
impl R {
    #[doc = "Bits 0:4 - the fifo size is equal to the template parameter \"fifo\"."]
    #[inline(always)]
