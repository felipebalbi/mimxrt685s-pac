#[doc = "Register `RAM16_RULE[%s]` reader"]
pub type R = crate::R<Ram16RuleSpec>;
#[doc = "Register `RAM16_RULE[%s]` writer"]
pub type W = crate::W<Ram16RuleSpec>;
#[doc = "Rule 0\n\nValue on reset: 0"]
...
#[doc = "SRAM Partition 16 Rule(n) Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ram16_rule::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ram16_rule::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ram16RuleSpec;
impl crate::RegisterSpec for Ram16RuleSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ram16_rule::R`](R) reader structure"]
impl crate::Readable for Ram16RuleSpec {}
#[doc = "`write(|w| ..)` method takes [`ram16_rule::W`](W) writer structure"]
impl crate::Writable for Ram16RuleSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RAM16_RULE[%s]
to value 0"]
impl crate::Resettable for Ram16RuleSpec {
