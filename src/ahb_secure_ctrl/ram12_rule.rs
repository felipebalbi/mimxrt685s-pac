#[doc = "Register `RAM12_RULE[%s]` reader"]
pub type R = crate::R<Ram12RuleSpec>;
#[doc = "Register `RAM12_RULE[%s]` writer"]
pub type W = crate::W<Ram12RuleSpec>;
#[doc = "Rule 0\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bits 0:1 - Rule 0"]
    #[inline(always)]
    pub fn rule0(&mut self) -> Rule0W<Ram12RuleSpec> {
        Rule0W::new(self, 0)
    }
    #[doc = "Bits 4:5 - Rule 1"]
    #[inline(always)]
    pub fn rule1(&mut self) -> Rule1W<Ram12RuleSpec> {
        Rule1W::new(self, 4)
    }
    #[doc = "Bits 8:9 - Rule 2"]
    #[inline(always)]
    pub fn rule2(&mut self) -> Rule2W<Ram12RuleSpec> {
        Rule2W::new(self, 8)
    }
    #[doc = "Bits 12:13 - Rule 3"]
    #[inline(always)]
    pub fn rule3(&mut self) -> Rule3W<Ram12RuleSpec> {
        Rule3W::new(self, 12)
    }
    #[doc = "Bits 16:17 - Rule 4"]
    #[inline(always)]
    pub fn rule4(&mut self) -> Rule4W<Ram12RuleSpec> {
        Rule4W::new(self, 16)
    }
    #[doc = "Bits 20:21 - Rule 5"]
    #[inline(always)]
    pub fn rule5(&mut self) -> Rule5W<Ram12RuleSpec> {
        Rule5W::new(self, 20)
    }
    #[doc = "Bits 24:25 - Rule 6"]
    #[inline(always)]
    pub fn rule6(&mut self) -> Rule6W<Ram12RuleSpec> {
        Rule6W::new(self, 24)
    }
    #[doc = "Bits 28:29 - Rule 7"]
    #[inline(always)]
    pub fn rule7(&mut self) -> Rule7W<Ram12RuleSpec> {
        Rule7W::new(self, 28)
    }
}
#[doc = "SRAM Partition 12 Rule(n) Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ram12_rule::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ram12_rule::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ram12RuleSpec;
impl crate::RegisterSpec for Ram12RuleSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ram12_rule::R`](R) reader structure"]
impl crate::Readable for Ram12RuleSpec {}
#[doc = "`write(|w| ..)` method takes [`ram12_rule::W`](W) writer structure"]
impl crate::Writable for Ram12RuleSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RAM12_RULE[%s]
to value 0"]
impl crate::Resettable for Ram12RuleSpec {
