#[doc = "Register `FLEXSPI0_REGION0_RULE[%s]` reader"]
pub type R = crate::R<Flexspi0Region0RuleSpec>;
#[doc = "Register `FLEXSPI0_REGION0_RULE[%s]` writer"]
pub type W = crate::W<Flexspi0Region0RuleSpec>;
#[doc = "Rule 0\n\nValue on reset: 0"]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FLEXSPI0_REGION0_RULE")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rule0(&mut self) -> Rule0W<Flexspi0Region0RuleSpec> {
        Rule0W::new(self, 0)
    }
    #[doc = "Bits 4:5 - Rule 1"]
    #[inline(always)]
    #[must_use]
    pub fn rule1(&mut self) -> Rule1W<Flexspi0Region0RuleSpec> {
        Rule1W::new(self, 4)
    }
    #[doc = "Bits 8:9 - Rule 2"]
    #[inline(always)]
    #[must_use]
    pub fn rule2(&mut self) -> Rule2W<Flexspi0Region0RuleSpec> {
        Rule2W::new(self, 8)
    }
    #[doc = "Bits 12:13 - Rule 3"]
    #[inline(always)]
    #[must_use]
    pub fn rule3(&mut self) -> Rule3W<Flexspi0Region0RuleSpec> {
        Rule3W::new(self, 12)
    }
    #[doc = "Bits 16:17 - Rule 4"]
    #[inline(always)]
    #[must_use]
    pub fn rule4(&mut self) -> Rule4W<Flexspi0Region0RuleSpec> {
        Rule4W::new(self, 16)
    }
    #[doc = "Bits 20:21 - Rule 5"]
    #[inline(always)]
    #[must_use]
    pub fn rule5(&mut self) -> Rule5W<Flexspi0Region0RuleSpec> {
        Rule5W::new(self, 20)
    }
    #[doc = "Bits 24:25 - Rule 6"]
    #[inline(always)]
    #[must_use]
    pub fn rule6(&mut self) -> Rule6W<Flexspi0Region0RuleSpec> {
        Rule6W::new(self, 24)
    }
    #[doc = "Bits 28:29 - Rule 7"]
    #[inline(always)]
    #[must_use]
    pub fn rule7(&mut self) -> Rule7W<Flexspi0Region0RuleSpec> {
        Rule7W::new(self, 28)
    }
}
...
#[doc = "`read()` method returns [`flexspi0_region0_rule::R`](R) reader structure"]
impl crate::Readable for Flexspi0Region0RuleSpec {}
#[doc = "`write(|w| ..)` method takes [`flexspi0_region0_rule::W`](W) writer structure"]
impl crate::Writable for Flexspi0Region0RuleSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FLEXSPI0_REGION0_RULE[%s]
to value 0"]
impl crate::Resettable for Flexspi0Region0RuleSpec {
