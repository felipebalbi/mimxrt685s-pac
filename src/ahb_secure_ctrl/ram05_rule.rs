#[doc = "Register `RAM05_RULE[%s]` reader"]
pub type R = crate::R<Ram05RuleSpec>;
#[doc = "Register `RAM05_RULE[%s]` writer"]
pub type W = crate::W<Ram05RuleSpec>;
#[doc = "Rule 0\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rule0(&mut self) -> Rule0W<Ram05RuleSpec> {
        Rule0W::new(self, 0)
    }
    #[doc = "Bits 4:5 - Rule 1"]
    #[inline(always)]
    #[must_use]
    pub fn rule1(&mut self) -> Rule1W<Ram05RuleSpec> {
        Rule1W::new(self, 4)
    }
    #[doc = "Bits 8:9 - Rule 2"]
    #[inline(always)]
    #[must_use]
    pub fn rule2(&mut self) -> Rule2W<Ram05RuleSpec> {
        Rule2W::new(self, 8)
    }
    #[doc = "Bits 12:13 - Rule 3"]
    #[inline(always)]
    #[must_use]
    pub fn rule3(&mut self) -> Rule3W<Ram05RuleSpec> {
        Rule3W::new(self, 12)
    }
    #[doc = "Bits 16:17 - Rule 4"]
    #[inline(always)]
    #[must_use]
    pub fn rule4(&mut self) -> Rule4W<Ram05RuleSpec> {
        Rule4W::new(self, 16)
    }
    #[doc = "Bits 20:21 - Rule 5"]
    #[inline(always)]
    #[must_use]
    pub fn rule5(&mut self) -> Rule5W<Ram05RuleSpec> {
        Rule5W::new(self, 20)
    }
    #[doc = "Bits 24:25 - Rule 6"]
    #[inline(always)]
    #[must_use]
    pub fn rule6(&mut self) -> Rule6W<Ram05RuleSpec> {
        Rule6W::new(self, 24)
    }
    #[doc = "Bits 28:29 - Rule 7"]
    #[inline(always)]
    #[must_use]
    pub fn rule7(&mut self) -> Rule7W<Ram05RuleSpec> {
        Rule7W::new(self, 28)
    }
}
#[doc = "SRAM Partition 05 Rule(n) Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ram05_rule::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ram05_rule::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ram05RuleSpec;
impl crate::RegisterSpec for Ram05RuleSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ram05_rule::R`](R) reader structure"]
impl crate::Readable for Ram05RuleSpec {}
#[doc = "`write(|w| ..)` method takes [`ram05_rule::W`](W) writer structure"]
impl crate::Writable for Ram05RuleSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RAM05_RULE[%s]
to value 0"]
impl crate::Resettable for Ram05RuleSpec {
