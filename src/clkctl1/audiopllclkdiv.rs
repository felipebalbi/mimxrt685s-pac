#[doc = "Register `AUDIOPLLCLKDIV` reader"]
pub type R = crate::R<AudiopllclkdivSpec>;
#[doc = "Register `AUDIOPLLCLKDIV` writer"]
pub type W = crate::W<AudiopllclkdivSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn div(&mut self) -> DivW<AudiopllclkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Resets the divider counter. Can be used to make sure a new divider value is used right away rather than completing the previous count."]
    #[inline(always)]
    #[must_use]
    pub fn reset(&mut self) -> ResetW<AudiopllclkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halts the divider counter. The intent is to allow the divider's clock source to be changed without the risk of a glitch at the output."]
    #[inline(always)]
    #[must_use]
    pub fn halt(&mut self) -> HaltW<AudiopllclkdivSpec> {
        HaltW::new(self, 30)
    }
    #[doc = "Bit 31 - Divider status flag. Set when a change is made to the divider value, cleared when the change is complete."]
    #[inline(always)]
    #[must_use]
    pub fn reqflag(&mut self) -> ReqflagW<AudiopllclkdivSpec> {
        ReqflagW::new(self, 31)
    }
}
#[doc = "audio pll0 clock divider\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`audiopllclkdiv::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`audiopllclkdiv::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AudiopllclkdivSpec;
impl crate::RegisterSpec for AudiopllclkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`audiopllclkdiv::R`](R) reader structure"]
impl crate::Readable for AudiopllclkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`audiopllclkdiv::W`](W) writer structure"]
impl crate::Writable for AudiopllclkdivSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets AUDIOPLLCLKDIV to value 0x4000_0000"]
impl crate::Resettable for AudiopllclkdivSpec {
