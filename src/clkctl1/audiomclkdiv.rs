#[doc = "Register `AUDIOMCLKDIV` reader"]
pub type R = crate::R<AudiomclkdivSpec>;
#[doc = "Register `AUDIOMCLKDIV` writer"]
pub type W = crate::W<AudiomclkdivSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn div(&mut self) -> DivW<AudiomclkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Resets the divider counter. Can be used to make sure a new divider value is used right away rather than completing the previous count."]
    #[inline(always)]
    #[must_use]
    pub fn reset(&mut self) -> ResetW<AudiomclkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halts the divider counter. The intent is to allow the divider's clock source to be changed without the risk of a glitch at the output."]
    #[inline(always)]
    #[must_use]
    pub fn halt(&mut self) -> HaltW<AudiomclkdivSpec> {
        HaltW::new(self, 30)
    }
    #[doc = "Bit 31 - Divider status flag. Set when a change is made to the divider value, cleared when the change is complete."]
    #[inline(always)]
    #[must_use]
    pub fn reqflag(&mut self) -> ReqflagW<AudiomclkdivSpec> {
        ReqflagW::new(self, 31)
    }
}
#[doc = "audio mclock divider\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`audiomclkdiv::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`audiomclkdiv::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AudiomclkdivSpec;
impl crate::RegisterSpec for AudiomclkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`audiomclkdiv::R`](R) reader structure"]
impl crate::Readable for AudiomclkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`audiomclkdiv::W`](W) writer structure"]
impl crate::Writable for AudiomclkdivSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets AUDIOMCLKDIV to value 0x4000_0000"]
impl crate::Resettable for AudiomclkdivSpec {
