...
pub type R = crate::R<FrgclkselSpec>;
#[doc = "Register `FRGCLKSEL` writer"]
pub type W = crate::W<FrgclkselSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sel(&mut self) -> SelW<FrgclkselSpec> {
        SelW::new(self, 0)
    }
}
#[doc = "FRG clock selection register N\n\nYou can [`read`](crate::Reg::read) this register and get [`frgclksel::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`frgclksel::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FrgclkselSpec;
impl crate::RegisterSpec for FrgclkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`frgclksel::R`](R) reader structure"]
impl crate::Readable for FrgclkselSpec {}
#[doc = "`write(|w| ..)` method takes [`frgclksel::W`](W) writer structure"]
impl crate::Writable for FrgclkselSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FRGCLKSEL to value 0x07"]
impl crate::Resettable for FrgclkselSpec {
