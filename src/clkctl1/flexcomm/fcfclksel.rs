#[doc = "Register `FCFCLKSEL` reader"]
pub type R = crate::R<FcfclkselSpec>;
#[doc = "Register `FCFCLKSEL` writer"]
pub type W = crate::W<FcfclkselSpec>;
...
#[doc = "flexcomm clock selection\n\nYou can [`read`](crate::Reg::read) this register and get [`fcfclksel::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fcfclksel::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FcfclkselSpec;
impl crate::RegisterSpec for FcfclkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fcfclksel::R`](R) reader structure"]
impl crate::Readable for FcfclkselSpec {}
#[doc = "`write(|w| ..)` method takes [`fcfclksel::W`](W) writer structure"]
impl crate::Writable for FcfclkselSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FCFCLKSEL to value 0x07"]
impl crate::Resettable for FcfclkselSpec {
