#[doc = "Register `FRG15CLKSEL` reader"]
pub type R = crate::R<Frg15clkselSpec>;
#[doc = "Register `FRG15CLKSEL` writer"]
pub type W = crate::W<Frg15clkselSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sel(&mut self) -> SelW<Frg15clkselSpec> {
        SelW::new(self, 0)
    }
}
#[doc = "FRG clock selection register 15\n\nYou can [`read`](crate::Reg::read) this register and get [`frg15clksel::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`frg15clksel::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Frg15clkselSpec;
impl crate::RegisterSpec for Frg15clkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`frg15clksel::R`](R) reader structure"]
impl crate::Readable for Frg15clkselSpec {}
#[doc = "`write(|w| ..)` method takes [`frg15clksel::W`](W) writer structure"]
impl crate::Writable for Frg15clkselSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FRG15CLKSEL to value 0x07"]
impl crate::Resettable for Frg15clkselSpec {
