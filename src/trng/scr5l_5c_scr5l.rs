...
pub type R = crate::R<Scr5l5cScr5lSpec>;
#[doc = "Register `SCR5L` writer"]
pub type W = crate::W<Scr5l5cScr5lSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn run5_max(&mut self) -> Run5MaxW<Scr5l5cScr5lSpec> {
        Run5MaxW::new(self, 0)
    }
    #[doc = "Bits 16:26 - Run Length 5 Range"]
    #[inline(always)]
    #[must_use]
    pub fn run5_rng(&mut self) -> Run5RngW<Scr5l5cScr5lSpec> {
        Run5RngW::new(self, 16)
    }
}
#[doc = "Statistical Check Run Length 5 Limit Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`scr5l_5c_scr5l::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`scr5l_5c_scr5l::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Scr5l5cScr5lSpec;
impl crate::RegisterSpec for Scr5l5cScr5lSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`scr5l_5c_scr5l::R`](R) reader structure"]
impl crate::Readable for Scr5l5cScr5lSpec {}
#[doc = "`write(|w| ..)` method takes [`scr5l_5c_scr5l::W`](W) writer structure"]
impl crate::Writable for Scr5l5cScr5lSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SCR5L to value 0x002e_002f"]
impl crate::Resettable for Scr5l5cScr5lSpec {
