...
pub type R = crate::R<Scr3l3cScr3lSpec>;
#[doc = "Register `SCR3L` writer"]
pub type W = crate::W<Scr3l3cScr3lSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn run3_max(&mut self) -> Run3MaxW<Scr3l3cScr3lSpec> {
        Run3MaxW::new(self, 0)
    }
    #[doc = "Bits 16:28 - Run Length 3 Range"]
    #[inline(always)]
    #[must_use]
    pub fn run3_rng(&mut self) -> Run3RngW<Scr3l3cScr3lSpec> {
        Run3RngW::new(self, 16)
    }
}
#[doc = "Statistical Check Run Length 3 Limit Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`scr3l_3c_scr3l::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`scr3l_3c_scr3l::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Scr3l3cScr3lSpec;
impl crate::RegisterSpec for Scr3l3cScr3lSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`scr3l_3c_scr3l::R`](R) reader structure"]
impl crate::Readable for Scr3l3cScr3lSpec {}
#[doc = "`write(|w| ..)` method takes [`scr3l_3c_scr3l::W`](W) writer structure"]
impl crate::Writable for Scr3l3cScr3lSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SCR3L to value 0x0058_007d"]
impl crate::Resettable for Scr3l3cScr3lSpec {
