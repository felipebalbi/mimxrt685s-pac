...
pub type R = crate::R<Scr5l5cScr5cSpec>;
...
#[doc = "Statistical Check Run Length 5 Count Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`scr5l_5c_scr5c::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Scr5l5cScr5cSpec;
impl crate::RegisterSpec for Scr5l5cScr5cSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`scr5l_5c_scr5c::R`](R) reader structure"]
impl crate::Readable for Scr5l5cScr5cSpec {}
#[doc = "`reset()` method sets SCR5C to value 0"]
impl crate::Resettable for Scr5l5cScr5cSpec {
