...
pub type R = crate::R<Scr2l2cScr2lSpec>;
#[doc = "Register `SCR2L` writer"]
pub type W = crate::W<Scr2l2cScr2lSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn run2_max(&mut self) -> Run2MaxW<Scr2l2cScr2lSpec> {
        Run2MaxW::new(self, 0)
    }
    #[doc = "Bits 16:29 - Run Length 2 Range"]
    #[inline(always)]
    #[must_use]
    pub fn run2_rng(&mut self) -> Run2RngW<Scr2l2cScr2lSpec> {
