...
pub type R = crate::R<Scr4l4cScr4lSpec>;
#[doc = "Register `SCR4L` writer"]
pub type W = crate::W<Scr4l4cScr4lSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn run4_max(&mut self) -> Run4MaxW<Scr4l4cScr4lSpec> {
        Run4MaxW::new(self, 0)
    }
    #[doc = "Bits 16:27 - Run Length 4 Range"]
    #[inline(always)]
    #[must_use]
    pub fn run4_rng(&mut self) -> Run4RngW<Scr4l4cScr4lSpec> {
        Run4RngW::new(self, 16)
    }
}
#[doc = "Statistical Check Run Length 4 Limit Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`scr4l_4c_scr4l::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`scr4l_4c_scr4l::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Scr4l4cScr4lSpec;
impl crate::RegisterSpec for Scr4l4cScr4lSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`scr4l_4c_scr4l::R`](R) reader structure"]
impl crate::Readable for Scr4l4cScr4lSpec {}
#[doc = "`write(|w| ..)` method takes [`scr4l_4c_scr4l::W`](W) writer structure"]
impl crate::Writable for Scr4l4cScr4lSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SCR4L to value 0x0040_004b"]
impl crate::Resettable for Scr4l4cScr4lSpec {
