...
pub type R = crate::R<Scr4l4cScr4cSpec>;
...
#[doc = "Statistical Check Run Length 4 Count Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`scr4l_4c_scr4c::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Scr4l4cScr4cSpec;
impl crate::RegisterSpec for Scr4l4cScr4cSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`scr4l_4c_scr4c::R`](R) reader structure"]
impl crate::Readable for Scr4l4cScr4cSpec {}
#[doc = "`reset()` method sets SCR4C to value 0"]
impl crate::Resettable for Scr4l4cScr4cSpec {
