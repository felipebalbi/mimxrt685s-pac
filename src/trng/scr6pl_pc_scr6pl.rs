...
pub type R = crate::R<Scr6plPcScr6plSpec>;
#[doc = "Register `SCR6PL` writer"]
pub type W = crate::W<Scr6plPcScr6plSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn run6p_max(&mut self) -> Run6pMaxW<Scr6plPcScr6plSpec> {
        Run6pMaxW::new(self, 0)
    }
    #[doc = "Bits 16:26 - Run Length 6+ Range"]
    #[inline(always)]
    #[must_use]
    pub fn run6p_rng(&mut self) -> Run6pRngW<Scr6plPcScr6plSpec> {
        Run6pRngW::new(self, 16)
    }
}
#[doc = "Statistical Check Run Length 6+ Limit Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`scr6pl_pc_scr6pl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`scr6pl_pc_scr6pl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Scr6plPcScr6plSpec;
impl crate::RegisterSpec for Scr6plPcScr6plSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`scr6pl_pc_scr6pl::R`](R) reader structure"]
impl crate::Readable for Scr6plPcScr6plSpec {}
#[doc = "`write(|w| ..)` method takes [`scr6pl_pc_scr6pl::W`](W) writer structure"]
impl crate::Writable for Scr6plPcScr6plSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SCR6PL to value 0x002e_002f"]
impl crate::Resettable for Scr6plPcScr6plSpec {
