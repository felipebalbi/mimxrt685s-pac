...
pub mod info;
#[doc = "EPLISTSTART (rw) register accessor: USB EP Command/Status List start address\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`epliststart::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`epliststart::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@epliststart`]
module"]
...
pub mod epliststart;
#[doc = "DATABUFSTART (rw) register accessor: USB Data buffer start address\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`databufstart::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`databufstart::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@databufstart`]
module"]
...
#[doc = "LPM (rw) register accessor: USB Link Power Management register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lpm::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lpm::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@lpm`]
module"]
#[doc(alias = "LPM")]
pub type Lpm = crate::Reg<lpm::LpmSpec>;
#[doc = "USB Link Power Management register"]
pub mod lpm;
#[doc = "EPSKIP (rw) register accessor: USB Endpoint skip\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`epskip::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`epskip::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@epskip`]
module"]
#[doc(alias = "EPSKIP")]
pub type Epskip = crate::Reg<epskip::EpskipSpec>;
#[doc = "USB Endpoint skip"]
pub mod epskip;
#[doc = "EPINUSE (rw) register accessor: USB Endpoint Buffer in use\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`epinuse::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`epinuse::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@epinuse`]
module"]
#[doc(alias = "EPINUSE")]
pub type Epinuse = crate::Reg<epinuse::EpinuseSpec>;
#[doc = "USB Endpoint Buffer in use"]
pub mod epinuse;
#[doc = "EPBUFCFG (rw) register accessor: USB Endpoint Buffer Configuration register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`epbufcfg::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`epbufcfg::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@epbufcfg`]
module"]
#[doc(alias = "EPBUFCFG")]
