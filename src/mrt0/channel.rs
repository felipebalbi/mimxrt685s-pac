...
#[doc = "INTVAL (rw) register accessor: MRT Time interval value register. This value is loaded into the TIMER register.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`intval::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`intval::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@intval`]
module"]
#[doc(alias = "INTVAL")]
