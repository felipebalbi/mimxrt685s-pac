...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn timer2_timer2_bc12(&self) -> &Timer2Timer2Bc12 {
        unsafe { &*(self as *const Self).cast::<u8>().add(24).cast() }
    }
    #[doc = "0x18 - TIMER2_BC11 register"]
    #[inline(always)]
    pub const fn timer2_timer2_bc11(&self) -> &Timer2Timer2Bc11 {
        unsafe { &*(self as *const Self).cast::<u8>().add(24).cast() }
    }
}
...
#[doc = "TIMER1 register"]
pub mod timer1;
#[doc = "TIMER2_TIMER2_BC11 (rw) register accessor: TIMER2_BC11 register\n\nYou can [`read`](crate::Reg::read) this register and get [`timer2_timer2_bc11::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timer2_timer2_bc11::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@timer2_timer2_bc11`]
module"]
#[doc(alias = "TIMER2_TIMER2_BC11")]
pub type Timer2Timer2Bc11 = crate::Reg<timer2_timer2_bc11::Timer2Timer2Bc11Spec>;
#[doc = "TIMER2_BC11 register"]
pub mod timer2_timer2_bc11;
#[doc = "TIMER2_TIMER2_BC12 (rw) register accessor: TIMER2_BC12 register\n\nYou can [`read`](crate::Reg::read) this register and get [`timer2_timer2_bc12::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timer2_timer2_bc12::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@timer2_timer2_bc12`]
module"]
#[doc(alias = "TIMER2_TIMER2_BC12")]
pub type Timer2Timer2Bc12 = crate::Reg<timer2_timer2_bc12::Timer2Timer2Bc12Spec>;
