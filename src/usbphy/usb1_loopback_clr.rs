...
pub type R = crate::R<Usb1LoopbackClrSpec>;
#[doc = "Register `USB1_LOOPBACK_CLR` writer"]
pub type W = crate::W<Usb1LoopbackClrSpec>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("USB1_LOOPBACK_CLR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn utmi_teststart(&mut self) -> UtmiTeststartW<Usb1LoopbackClrSpec> {
        UtmiTeststartW::new(self, 0)
    }
    #[doc = "Bit 1 - Mode control for USB loopback test"]
    #[inline(always)]
    #[must_use]
    pub fn utmi_dig_tst0(&mut self) -> UtmiDigTst0W<Usb1LoopbackClrSpec> {
        UtmiDigTst0W::new(self, 1)
    }
    #[doc = "Bit 2 - Mode control for USB loopback test"]
    #[inline(always)]
    #[must_use]
    pub fn utmi_dig_tst1(&mut self) -> UtmiDigTst1W<Usb1LoopbackClrSpec> {
        UtmiDigTst1W::new(self, 2)
    }
    #[doc = "Bit 3 - Select HS or FS mode for USB loopback testing"]
    #[inline(always)]
    #[must_use]
    pub fn tsti_tx_hs_mode(&mut self) -> TstiTxHsModeW<Usb1LoopbackClrSpec> {
        TstiTxHsModeW::new(self, 3)
    }
    #[doc = "Bit 4 - Set to value 1'b1 to choose LS for USB loopback testing, set to value 1'b0 to choose HS or FS mode which is defined by TSTI1_TX_HS"]
    #[inline(always)]
    #[must_use]
    pub fn tsti_tx_ls_mode(&mut self) -> TstiTxLsModeW<Usb1LoopbackClrSpec> {
        TstiTxLsModeW::new(self, 4)
    }
    #[doc = "Bit 5 - Enable TX for USB loopback test."]
    #[inline(always)]
    #[must_use]
    pub fn tsti_tx_en(&mut self) -> TstiTxEnW<Usb1LoopbackClrSpec> {
        TstiTxEnW::new(self, 5)
    }
    #[doc = "Bit 6 - Sets TX Hi-Z for USB loopback test."]
    #[inline(always)]
    #[must_use]
    pub fn tsti_tx_hiz(&mut self) -> TstiTxHizW<Usb1LoopbackClrSpec> {
        TstiTxHizW::new(self, 6)
    }
    #[doc = "Bit 7 - This read-only bit is a status bit for USB loopback test results"]
    #[inline(always)]
    #[must_use]
    pub fn utmo_dig_tst0(&mut self) -> UtmoDigTst0W<Usb1LoopbackClrSpec> {
        UtmoDigTst0W::new(self, 7)
    }
    #[doc = "Bit 8 - This read-only bit is a status bit for USB loopback test"]
    #[inline(always)]
    #[must_use]
    pub fn utmo_dig_tst1(&mut self) -> UtmoDigTst1W<Usb1LoopbackClrSpec> {
        UtmoDigTst1W::new(self, 8)
    }
    #[doc = "Bit 15 - Setting this bit field to value 1'b1 will enable the loopback test to dynamically change the packet speed"]
    #[inline(always)]
    #[must_use]
    pub fn tsti_hsfs_mode_en(&mut self) -> TstiHsfsModeEnW<Usb1LoopbackClrSpec> {
        TstiHsfsModeEnW::new(self, 15)
    }
    #[doc = "Bits 16:23 - Selects the packet data byte used for USB loopback testing in Pulse mode"]
    #[inline(always)]
    #[must_use]
    pub fn tstpkt(&mut self) -> TstpktW<Usb1LoopbackClrSpec> {
        TstpktW::new(self, 16)
    }
}
#[doc = "USB PHY Loopback Control/Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`usb1_loopback_clr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`usb1_loopback_clr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Usb1LoopbackClrSpec;
impl crate::RegisterSpec for Usb1LoopbackClrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb1_loopback_clr::R`](R) reader structure"]
impl crate::Readable for Usb1LoopbackClrSpec {}
#[doc = "`write(|w| ..)` method takes [`usb1_loopback_clr::W`](W) writer structure"]
impl crate::Writable for Usb1LoopbackClrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets USB1_LOOPBACK_CLR to value 0x0055_0000"]
impl crate::Resettable for Usb1LoopbackClrSpec {
