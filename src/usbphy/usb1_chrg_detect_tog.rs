#[doc = "Register `USB1_CHRG_DETECT_TOG` reader"]
pub type R = crate::R<Usb1ChrgDetectTogSpec>;
#[doc = "Register `USB1_CHRG_DETECT_TOG` writer"]
pub type W = crate::W<Usb1ChrgDetectTogSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pullup_dp(&mut self) -> PullupDpW<Usb1ChrgDetectTogSpec> {
        PullupDpW::new(self, 2)
    }
    #[doc = "Bit 23 - USB charge detector bias current reference This bit determines the reference for the bias current of the USB charge detector"]
    #[inline(always)]
    #[must_use]
    pub fn bgr_ibias(&mut self) -> BgrIbiasW<Usb1ChrgDetectTogSpec> {
        BgrIbiasW::new(self, 23)
    }
}
#[doc = "USB PHY Charger Detect Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`usb1_chrg_detect_tog::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`usb1_chrg_detect_tog::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Usb1ChrgDetectTogSpec;
impl crate::RegisterSpec for Usb1ChrgDetectTogSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb1_chrg_detect_tog::R`](R) reader structure"]
impl crate::Readable for Usb1ChrgDetectTogSpec {}
#[doc = "`write(|w| ..)` method takes [`usb1_chrg_detect_tog::W`](W) writer structure"]
impl crate::Writable for Usb1ChrgDetectTogSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets USB1_CHRG_DETECT_TOG to value 0x8018_0000"]
impl crate::Resettable for Usb1ChrgDetectTogSpec {
