...
between the VBUS_VALID comparator and the Session Valid comparator"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn en_charger_resistor(&mut self) -> EnChargerResistorW<Usb1VbusDetectSpec> {
        EnChargerResistorW::new(self, 31)
    }
}
#[doc = "USB PHY VBUS Detect Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`usb1_vbus_detect::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`usb1_vbus_detect::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
