...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pll_bypass(&mut self) -> PllBypassW<PllSicSetSpec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pll_lock(&mut self) -> PllLockW<PllSicSetSpec> {
        PllLockW::new(self, 31)
    }
}
#[doc = "USB PHY PLL Control/Status Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pll_sic_set::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pll_sic_set::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
