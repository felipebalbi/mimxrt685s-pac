...
pub type R = crate::R<Usb1LoopbackHsfscntTogSpec>;
#[doc = "Register `USB1_LOOPBACK_HSFSCNT_TOG` writer"]
pub type W = crate::W<Usb1LoopbackHsfscntTogSpec>;
...
is set to value 1'b1."]
    #[inline(always)]
    #[must_use]
    pub fn tsti_hs_number(&mut self) -> TstiHsNumberW<Usb1LoopbackHsfscntTogSpec> {
...
is set to value 1'b1."]
    #[inline(always)]
    #[must_use]
    pub fn tsti_fs_number(&mut self) -> TstiFsNumberW<Usb1LoopbackHsfscntTogSpec> {
        TstiFsNumberW::new(self, 16)
    }
}
#[doc = "USB PHY Loopback Packet Number Select Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`usb1_loopback_hsfscnt_tog::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`usb1_loopback_hsfscnt_tog::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Usb1LoopbackHsfscntTogSpec;
impl crate::RegisterSpec for Usb1LoopbackHsfscntTogSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb1_loopback_hsfscnt_tog::R`](R) reader structure"]
impl crate::Readable for Usb1LoopbackHsfscntTogSpec {}
#[doc = "`write(|w| ..)` method takes [`usb1_loopback_hsfscnt_tog::W`](W) writer structure"]
impl crate::Writable for Usb1LoopbackHsfscntTogSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets USB1_LOOPBACK_HSFSCNT_TOG to value 0x0004_0010"]
impl crate::Resettable for Usb1LoopbackHsfscntTogSpec {
