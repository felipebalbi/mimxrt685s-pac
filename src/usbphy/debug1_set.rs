...
pub type R = crate::R<Debug1SetSpec>;
#[doc = "Register `DEBUG1_SET` writer"]
pub type W = crate::W<Debug1SetSpec>;
...
impl W {
    #[doc = "Bits 13:14 - Delay increment of the rise of squelch:"]
    #[inline(always)]
    pub fn entailadjvd(&mut self) -> EntailadjvdW<Debug1SetSpec> {
        EntailadjvdW::new(self, 13)
    }
    #[doc = "Bits 18:20 - Adjustment bits on bandgap"]
    #[inline(always)]
    pub fn usb2_refbias_vbgadj(&mut self) -> Usb2RefbiasVbgadjW<Debug1SetSpec> {
        Usb2RefbiasVbgadjW::new(self, 18)
    }
    #[doc = "Bits 21:22 - Bias current control for usb2_phy"]
    #[inline(always)]
    pub fn usb2_refbias_tst(&mut self) -> Usb2RefbiasTstW<Debug1SetSpec> {
