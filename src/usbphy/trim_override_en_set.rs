#[doc = "Register `TRIM_OVERRIDE_EN_SET` reader"]
pub type R = crate::R<TrimOverrideEnSetSpec>;
#[doc = "Register `TRIM_OVERRIDE_EN_SET` writer"]
pub type W = crate::W<TrimOverrideEnSetSpec>;
...
will be used."]
    #[inline(always)]
    #[must_use]
    pub fn trim_div_sel_override(&mut self) -> TrimDivSelOverrideW<TrimOverrideEnSetSpec> {
...
will be used."]
    ...
    pub fn trim_env_tail_adj_vd_override(
        &mut self,
    ) -> TrimEnvTailAdjVdOverrideW<TrimOverrideEnSetSpec> {
...
will be used."]
    #[inline(always)]
    #[must_use]
    pub fn trim_tx_d_cal_override(&mut self) -> TrimTxDCalOverrideW<TrimOverrideEnSetSpec> {
...
will be used."]
    #[inline(always)]
    #[must_use]
    pub fn trim_tx_cal45dp_override(&mut self) -> TrimTxCal45dpOverrideW<TrimOverrideEnSetSpec> {
...
will be used."]
    #[inline(always)]
    #[must_use]
    pub fn trim_tx_cal45dm_override(&mut self) -> TrimTxCal45dmOverrideW<TrimOverrideEnSetSpec> {
    ...
    pub fn trim_refbias_vbgadj_override(
        &mut self,
    ) -> TrimRefbiasVbgadjOverrideW<TrimOverrideEnSetSpec> {
...
will be used"]
    #[inline(always)]
    #[must_use]
    pub fn trim_refbias_tst_override(&mut self) -> TrimRefbiasTstOverrideW<TrimOverrideEnSetSpec> {
        TrimRefbiasTstOverrideW::new(self, 6)
    }
    #[doc = "Bits 10:12 - Adjustment bits for bandgap"]
    #[inline(always)]
    #[must_use]
    pub fn trim_usb2_refbias_vbgadj(&mut self) -> TrimUsb2RefbiasVbgadjW<TrimOverrideEnSetSpec> {
        TrimUsb2RefbiasVbgadjW::new(self, 10)
    }
    #[doc = "Bits 13:14 - Bias current control for usb2_phy"]
    #[inline(always)]
    #[must_use]
    pub fn trim_usb2_refbias_tst(&mut self) -> TrimUsb2RefbiasTstW<TrimOverrideEnSetSpec> {
        TrimUsb2RefbiasTstW::new(self, 13)
    }
    #[doc = "Bits 15:17 - IFR value of PLL_DIV_SEL."]
    #[inline(always)]
    #[must_use]
    pub fn trim_pll_ctrl0_div_sel(&mut self) -> TrimPllCtrl0DivSelW<TrimOverrideEnSetSpec> {
    ...
    pub fn trim_usb_reg_env_tail_adj_vd(
        &mut self,
    ) -> TrimUsbRegEnvTailAdjVdW<TrimOverrideEnSetSpec> {
        TrimUsbRegEnvTailAdjVdW::new(self, 18)
    }
    #[doc = "Bits 20:23 - IFR value of TX_D_CAL."]
    #[inline(always)]
    #[must_use]
    pub fn trim_usbphy_tx_d_cal(&mut self) -> TrimUsbphyTxDCalW<TrimOverrideEnSetSpec> {
        TrimUsbphyTxDCalW::new(self, 20)
    }
    #[doc = "Bits 24:27 - IFR value of TX_CAL45DP."]
    #[inline(always)]
    #[must_use]
    pub fn trim_usbphy_tx_cal45dp(&mut self) -> TrimUsbphyTxCal45dpW<TrimOverrideEnSetSpec> {
        TrimUsbphyTxCal45dpW::new(self, 24)
    }
    #[doc = "Bits 28:31 - IFR value of TX_CAL45DM."]
    #[inline(always)]
    #[must_use]
    pub fn trim_usbphy_tx_cal45dm(&mut self) -> TrimUsbphyTxCal45dmW<TrimOverrideEnSetSpec> {
        TrimUsbphyTxCal45dmW::new(self, 28)
    }
}
#[doc = "USB PHY Trim Override Enable Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`trim_override_en_set::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`trim_override_en_set::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TrimOverrideEnSetSpec;
impl crate::RegisterSpec for TrimOverrideEnSetSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`trim_override_en_set::R`](R) reader structure"]
impl crate::Readable for TrimOverrideEnSetSpec {}
#[doc = "`write(|w| ..)` method takes [`trim_override_en_set::W`](W) writer structure"]
impl crate::Writable for TrimOverrideEnSetSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TRIM_OVERRIDE_EN_SET to value 0x7f"]
impl crate::Resettable for TrimOverrideEnSetSpec {
