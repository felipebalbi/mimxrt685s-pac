#[doc = "Register `TRIM_OVERRIDE_EN_TOG` reader"]
pub type R = crate::R<TrimOverrideEnTogSpec>;
#[doc = "Register `TRIM_OVERRIDE_EN_TOG` writer"]
pub type W = crate::W<TrimOverrideEnTogSpec>;
...
will be used."]
    #[inline(always)]
    #[must_use]
    pub fn trim_div_sel_override(&mut self) -> TrimDivSelOverrideW<TrimOverrideEnTogSpec> {
...
will be used."]
    ...
    pub fn trim_env_tail_adj_vd_override(
        &mut self,
    ) -> TrimEnvTailAdjVdOverrideW<TrimOverrideEnTogSpec> {
...
will be used."]
    #[inline(always)]
    #[must_use]
    pub fn trim_tx_d_cal_override(&mut self) -> TrimTxDCalOverrideW<TrimOverrideEnTogSpec> {
...
will be used."]
    #[inline(always)]
    #[must_use]
    pub fn trim_tx_cal45dp_override(&mut self) -> TrimTxCal45dpOverrideW<TrimOverrideEnTogSpec> {
...
will be used."]
    #[inline(always)]
    #[must_use]
    pub fn trim_tx_cal45dm_override(&mut self) -> TrimTxCal45dmOverrideW<TrimOverrideEnTogSpec> {
    ...
    pub fn trim_refbias_vbgadj_override(
        &mut self,
    ) -> TrimRefbiasVbgadjOverrideW<TrimOverrideEnTogSpec> {
...
will be used"]
    #[inline(always)]
    #[must_use]
    pub fn trim_refbias_tst_override(&mut self) -> TrimRefbiasTstOverrideW<TrimOverrideEnTogSpec> {
        TrimRefbiasTstOverrideW::new(self, 6)
    }
    #[doc = "Bits 10:12 - Adjustment bits for bandgap"]
    #[inline(always)]
    #[must_use]
    pub fn trim_usb2_refbias_vbgadj(&mut self) -> TrimUsb2RefbiasVbgadjW<TrimOverrideEnTogSpec> {
        TrimUsb2RefbiasVbgadjW::new(self, 10)
    }
    #[doc = "Bits 13:14 - Bias current control for usb2_phy"]
    #[inline(always)]
    #[must_use]
    pub fn trim_usb2_refbias_tst(&mut self) -> TrimUsb2RefbiasTstW<TrimOverrideEnTogSpec> {
        TrimUsb2RefbiasTstW::new(self, 13)
    }
    #[doc = "Bits 15:17 - IFR value of PLL_DIV_SEL."]
    #[inline(always)]
    #[must_use]
    pub fn trim_pll_ctrl0_div_sel(&mut self) -> TrimPllCtrl0DivSelW<TrimOverrideEnTogSpec> {
    ...
    pub fn trim_usb_reg_env_tail_adj_vd(
        &mut self,
    ) -> TrimUsbRegEnvTailAdjVdW<TrimOverrideEnTogSpec> {
        TrimUsbRegEnvTailAdjVdW::new(self, 18)
    }
    #[doc = "Bits 20:23 - IFR value of TX_D_CAL."]
    #[inline(always)]
    #[must_use]
    pub fn trim_usbphy_tx_d_cal(&mut self) -> TrimUsbphyTxDCalW<TrimOverrideEnTogSpec> {
        TrimUsbphyTxDCalW::new(self, 20)
    }
    #[doc = "Bits 24:27 - IFR value of TX_CAL45DP."]
    #[inline(always)]
    #[must_use]
    pub fn trim_usbphy_tx_cal45dp(&mut self) -> TrimUsbphyTxCal45dpW<TrimOverrideEnTogSpec> {
        TrimUsbphyTxCal45dpW::new(self, 24)
    }
    #[doc = "Bits 28:31 - IFR value of TX_CAL45DM."]
    #[inline(always)]
    #[must_use]
    pub fn trim_usbphy_tx_cal45dm(&mut self) -> TrimUsbphyTxCal45dmW<TrimOverrideEnTogSpec> {
        TrimUsbphyTxCal45dmW::new(self, 28)
    }
}
#[doc = "USB PHY Trim Override Enable Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`trim_override_en_tog::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`trim_override_en_tog::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TrimOverrideEnTogSpec;
impl crate::RegisterSpec for TrimOverrideEnTogSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`trim_override_en_tog::R`](R) reader structure"]
impl crate::Readable for TrimOverrideEnTogSpec {}
#[doc = "`write(|w| ..)` method takes [`trim_override_en_tog::W`](W) writer structure"]
impl crate::Writable for TrimOverrideEnTogSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TRIM_OVERRIDE_EN_TOG to value 0x7f"]
impl crate::Resettable for TrimOverrideEnTogSpec {
