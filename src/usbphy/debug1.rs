...
impl W {
    #[doc = "Bits 13:14 - Delay increment of the rise of squelch:"]
    #[inline(always)]
    pub fn entailadjvd(&mut self) -> EntailadjvdW<Debug1Spec> {
        EntailadjvdW::new(self, 13)
    }
    #[doc = "Bits 18:20 - Adjustment bits on bandgap"]
    #[inline(always)]
    pub fn usb2_refbias_vbgadj(&mut self) -> Usb2RefbiasVbgadjW<Debug1Spec> {
        Usb2RefbiasVbgadjW::new(self, 18)
    }
    #[doc = "Bits 21:22 - Bias current control for usb2_phy"]
    #[inline(always)]
    pub fn usb2_refbias_tst(&mut self) -> Usb2RefbiasTstW<Debug1Spec> {
        Usb2RefbiasTstW::new(self, 21)
    }
}
#[doc = "UTMI Debug Status Register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`debug1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`debug1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets DEBUG1 to value 0x1000"]
