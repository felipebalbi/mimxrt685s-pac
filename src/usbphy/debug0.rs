...
pub type R = crate::R<Debug0Spec>;
#[doc = "Register `DEBUG0` writer"]
pub type W = crate::W<Debug0Spec>;
...
impl W {
    #[doc = "Bit 1 - Use holding registers to assist in timing for external UTMI interface."]
    #[inline(always)]
    pub fn debug_interface_hold(&mut self) -> DebugInterfaceHoldW<Debug0Spec> {
        DebugInterfaceHoldW::new(self, 1)
    }
    #[doc = "Bits 2:3 - This bit field selects whether to connect pulldown resistors on the USB_DP/USB_DM pins if the corresponding pulldown overdrive mode is enabled through DEBUG\\[5:4} Set bit 3 to value 1'b1 to connect the 15ohm pulldown on USB_DP line"]
    #[inline(always)]
    pub fn hstpulldown(&mut self) -> HstpulldownW<Debug0Spec> {
        HstpulldownW::new(self, 2)
    }
    #[doc = "Bits 4:5 - This bit field selects host pulldown overdrive mode"]
    #[inline(always)]
    pub fn enhstpulldown(&mut self) -> EnhstpulldownW<Debug0Spec> {
        EnhstpulldownW::new(self, 4)
    }
    #[doc = "Bits 8:11 - Delay in between the end of transmit to the beginning of receive"]
    #[inline(always)]
    pub fn tx2rxcount(&mut self) -> Tx2rxcountW<Debug0Spec> {
        Tx2rxcountW::new(self, 8)
    }
    #[doc = "Bit 12 - Set this bit to allow a countdown to transition in between TX and RX."]
    #[inline(always)]
    pub fn entx2rxcount(&mut self) -> Entx2rxcountW<Debug0Spec> {
        Entx2rxcountW::new(self, 12)
    }
    #[doc = "Bits 16:20 - Delay in between the detection of squelch to the reset of high-speed RX."]
    #[inline(always)]
    pub fn squelchresetcount(&mut self) -> SquelchresetcountW<Debug0Spec> {
        SquelchresetcountW::new(self, 16)
    }
    #[doc = "Bit 24 - Set bit to allow squelch to reset high-speed receive."]
    #[inline(always)]
    pub fn ensquelchreset(&mut self) -> EnsquelchresetW<Debug0Spec> {
        EnsquelchresetW::new(self, 24)
    }
    #[doc = "Bits 25:28 - Duration of RESET in terms of the number of 480-MHz cycles."]
    #[inline(always)]
    pub fn squelchresetlength(&mut self) -> SquelchresetlengthW<Debug0Spec> {
        SquelchresetlengthW::new(self, 25)
    }
    #[doc = "Bit 29 - Choose to trigger the host resume SE0 with HOST_FORCE_LS_SE0 = 0 or UTMI_SUSPEND = 1."]
    #[inline(always)]
    pub fn host_resume_debug(&mut self) -> HostResumeDebugW<Debug0Spec> {
        HostResumeDebugW::new(self, 29)
    }
    #[doc = "Bit 30 - Gate Test Clocks"]
    #[inline(always)]
    pub fn clkgate(&mut self) -> ClkgateW<Debug0Spec> {
        ClkgateW::new(self, 30)
    }
}
#[doc = "USB PHY Debug Register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`debug0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`debug0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Debug0Spec;
impl crate::RegisterSpec for Debug0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`debug0::R`](R) reader structure"]
impl crate::Readable for Debug0Spec {}
#[doc = "`write(|w| ..)` method takes [`debug0::W`](W) writer structure"]
impl crate::Writable for Debug0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DEBUG0 to value 0x7f18_0000"]
impl crate::Resettable for Debug0Spec {
