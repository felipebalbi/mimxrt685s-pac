...
impl VddPorR {
    ...
    pub const fn variant(&self) -> VddPor {
        match self.bits {
            false => VddPor::NoEventDetected,
            true => VddPor::PorEventDetected,
        }
    }
    #[doc = "No event detected."]
    #[inline(always)]
    pub fn is_no_event_detected(&self) -> bool {
        *self == VddPor::NoEventDetected
    }
    #[doc = "VDD POR event detected. (Writing a '1' to this bit clears this status)."]
    #[inline(always)]
    pub fn is_por_event_detected(&self) -> bool {
        *self == VddPor::PorEventDetected
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn no_event_detected(self) -> &'a mut crate::W<REG> {
        self.variant(VddPor::NoEventDetected)
    }
    #[doc = "VDD POR event detected. (Writing a '1' to this bit clears this status)."]
    #[inline(always)]
    pub fn por_event_detected(self) -> &'a mut crate::W<REG> {
        self.variant(VddPor::PorEventDetected)
    }
}
