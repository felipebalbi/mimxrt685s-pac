...
pub mod intstat;
#[doc = "AREG (rw) register accessor: A register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`areg::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`areg::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@areg`]
module"]
#[doc(alias = "AREG")]
...
#[doc = "B register"]
pub mod breg;
#[doc = "CREG (rw) register accessor: C register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`creg::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`creg::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@creg`]
module"]
#[doc(alias = "CREG")]
pub type Creg = crate::Reg<creg::CregSpec>;
#[doc = "C register"]
pub mod creg;
#[doc = "DREG (rw) register accessor: D register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dreg::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dreg::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@dreg`]
module"]
#[doc(alias = "DREG")]
...
pub mod mask;
#[doc = "REMASK (rw) register accessor: Optional re-mask register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`remask::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`remask::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@remask`]
module"]
#[doc(alias = "REMASK")]
