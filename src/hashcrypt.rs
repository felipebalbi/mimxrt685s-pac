...
pub mod memctrl;
#[doc = "MEMADDR (rw) register accessor: Address to start memory access from (if available).\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`memaddr::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`memaddr::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@memaddr`]
module"]
#[doc(alias = "MEMADDR")]
pub type Memaddr = crate::Reg<memaddr::MemaddrSpec>;
#[doc = "Address to start memory access from (if available)."]
pub mod memaddr;
#[doc = "INDATA (w) register accessor: Input of 16 words at a time to load up buffer.\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`indata::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@indata`]
module"]
#[doc(alias = "INDATA")]
pub type Indata = crate::Reg<indata::IndataSpec>;
#[doc = "Input of 16 words at a time to load up buffer."]
pub mod indata;
#[doc = "ALIAS (w) register accessor: no description available\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`alias::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@alias`]
module"]
#[doc(alias = "ALIAS")]
pub type Alias = crate::Reg<alias::AliasSpec>;
#[doc = "no description available"]
pub mod alias;
#[doc = "DIGEST0 (r) register accessor: no description available\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`digest0::R`].  See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@digest0`]
module"]
#[doc(alias = "DIGEST0")]
pub type Digest0 = crate::Reg<digest0::Digest0Spec>;
#[doc = "no description available"]
pub mod digest0;
#[doc = "CRYPTCFG (rw) register accessor: Crypto settings for AES and Salsa and ChaCha\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cryptcfg::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cryptcfg::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@cryptcfg`]
module"]
#[doc(alias = "CRYPTCFG")]
...
pub mod lock;
#[doc = "MASK (w) register accessor: no description available\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mask::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@mask`]
module"]
#[doc(alias = "MASK")]
pub type Mask = crate::Reg<mask::MaskSpec>;
#[doc = "no description available"]
pub mod mask;
#[doc = "RELOAD (w) register accessor: no description available\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`reload::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@reload`]
module"]
#[doc(alias = "RELOAD")]
pub type Reload = crate::Reg<reload::ReloadSpec>;
#[doc = "no description available"]
pub mod reload;
#[doc = "PRNG_SEED (w) register accessor: PRNG random seed input value used as an entropy source\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`prng_seed::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@prng_seed`]
module"]
#[doc(alias = "PRNG_SEED")]
pub type PrngSeed = crate::Reg<prng_seed::PrngSeedSpec>;
#[doc = "PRNG random seed input value used as an entropy source"]
pub mod prng_seed;
#[doc = "PRNG_OUT (r) register accessor: PRNG software-accessable random output value\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`prng_out::R`].  See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@prng_out`]
module"]
#[doc(alias = "PRNG_OUT")]
