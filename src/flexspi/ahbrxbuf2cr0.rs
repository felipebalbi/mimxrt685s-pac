#[doc = "Register `AHBRXBUF2CR0` reader"]
pub type R = crate::R<Ahbrxbuf2cr0Spec>;
#[doc = "Register `AHBRXBUF2CR0` writer"]
pub type W = crate::W<Ahbrxbuf2cr0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bufsz(&mut self) -> BufszW<Ahbrxbuf2cr0Spec> {
        BufszW::new(self, 0)
    }
    #[doc = "Bits 16:19 - This AHB RX Buffer is assigned according to AHB Master with ID (MSTR_ID)."]
    #[inline(always)]
    #[must_use]
    pub fn mstrid(&mut self) -> MstridW<Ahbrxbuf2cr0Spec> {
        MstridW::new(self, 16)
    }
    #[doc = "Bits 24:26 - This priority for AHB Master Read which this AHB RX Buffer is assigned. 7 is the highest priority, 0 the lowest."]
    #[inline(always)]
    #[must_use]
    pub fn priority(&mut self) -> PriorityW<Ahbrxbuf2cr0Spec> {
        PriorityW::new(self, 24)
    }
    #[doc = "Bit 31 - AHB Read Prefetch Enable for current AHB RX Buffer corresponding Master."]
    #[inline(always)]
    #[must_use]
    pub fn prefetchen(&mut self) -> PrefetchenW<Ahbrxbuf2cr0Spec> {
        PrefetchenW::new(self, 31)
    }
}
#[doc = "AHB RX Buffer 2 Control Register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ahbrxbuf2cr0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ahbrxbuf2cr0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ahbrxbuf2cr0Spec;
impl crate::RegisterSpec for Ahbrxbuf2cr0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ahbrxbuf2cr0::R`](R) reader structure"]
impl crate::Readable for Ahbrxbuf2cr0Spec {}
#[doc = "`write(|w| ..)` method takes [`ahbrxbuf2cr0::W`](W) writer structure"]
impl crate::Writable for Ahbrxbuf2cr0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets AHBRXBUF2CR0 to value 0x8002_0020"]
impl crate::Resettable for Ahbrxbuf2cr0Spec {
    const RESET_VALUE: u32 = 0x8002_0020;
}
