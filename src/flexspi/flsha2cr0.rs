...
pub type R = crate::R<Flsha2cr0Spec>;
#[doc = "Register `FLSHA2CR0` writer"]
pub type W = crate::W<Flsha2cr0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn flshsz(&mut self) -> FlshszW<Flsha2cr0Spec> {
        FlshszW::new(self, 0)
    }
}
#[doc = "Flash Control Register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`flsha2cr0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`flsha2cr0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Flsha2cr0Spec;
impl crate::RegisterSpec for Flsha2cr0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flsha2cr0::R`](R) reader structure"]
impl crate::Readable for Flsha2cr0Spec {}
#[doc = "`write(|w| ..)` method takes [`flsha2cr0::W`](W) writer structure"]
impl crate::Writable for Flsha2cr0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FLSHA2CR0 to value 0x0001_0000"]
impl crate::Resettable for Flsha2cr0Spec {
