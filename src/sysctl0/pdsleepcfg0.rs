...
pub type R = crate::R<Pdsleepcfg0Spec>;
...
impl From<MainclkShutoff> for bool {
    #[inline(always)]
    fn from(variant: MainclkShutoff) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `MAINCLK_SHUTOFF` reader - main clock shut off"]
pub type MainclkShutoffR = crate::BitReader<MainclkShutoff>;
impl MainclkShutoffR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> MainclkShutoff {
        match self.bits {
            false => MainclkShutoff::ClockEnabled,
            true => MainclkShutoff::ClockGated,
        }
    }
    #[doc = "Clocks enabled"]
    #[inline(always)]
    pub fn is_clock_enabled(&self) -> bool {
        *self == MainclkShutoff::ClockEnabled
    }
    #[doc = "Clocks gated"]
    #[inline(always)]
    pub fn is_clock_gated(&self) -> bool {
        *self == MainclkShutoff::ClockGated
    }
}
#[doc = "Field `MAINCLK_SHUTOFF` writer - main clock shut off"]
pub type MainclkShutoffW<'a, REG> = crate::BitWriter<'a, REG, MainclkShutoff>;
impl<'a, REG> MainclkShutoffW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn clock_enabled(self) -> &'a mut crate::W<REG> {
        self.variant(MainclkShutoff::ClockEnabled)
    }
    #[doc = "Clocks gated"]
    #[inline(always)]
    pub fn clock_gated(self) -> &'a mut crate::W<REG> {
        self.variant(MainclkShutoff::ClockGated)
    }
}
...
impl From<DeepPd> for bool {
    #[inline(always)]
    fn from(variant: DeepPd) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `DEEP_PD` reader - no description available"]
pub type DeepPdR = crate::BitReader<DeepPd>;
impl DeepPdR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> DeepPd {
        match self.bits {
            false => DeepPd::Enabled,
            true => DeepPd::PowerDown,
        }
    }
    #[doc = "enabled"]
    #[inline(always)]
    ...
    pub fn is_power_down(&self) -> bool {
        *self == DeepPd::PowerDown
    }
}
#[doc = "Field `DEEP_PD` writer - no description available"]
pub type DeepPdW<'a, REG> = crate::BitWriter<'a, REG, DeepPd>;
impl<'a, REG> DeepPdW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "enabled"]
    ...
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(DeepPd::Enabled)
    }
    #[doc = "power down"]
    #[inline(always)]
    pub fn power_down(self) -> &'a mut crate::W<REG> {
        self.variant(DeepPd::PowerDown)
    }
}
#[doc = "no description available\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
...
#[doc = "Field `RBB_PD` reader - Writes to this bit in PDRUNCFG, but not PDSLEEPCFG, can be disabled by an OTP bit."]
pub type RbbPdR = crate::BitReader<RbbPd>;
impl RbbPdR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> RbbPd {
        match self.bits {
            false => RbbPd::Enabled,
            true => RbbPd::PowerDown,
        }
    }
    #[doc = "enabled"]
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn is_power_down(&self) -> bool {
        *self == RbbPd::PowerDown
    }
}
#[doc = "Field `RBB_PD` writer - Writes to this bit in PDRUNCFG, but not PDSLEEPCFG, can be disabled by an OTP bit."]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(RbbPd::Enabled)
    }
    #[doc = "power down"]
    #[inline(always)]
    pub fn power_down(self) -> &'a mut crate::W<REG> {
        self.variant(RbbPd::PowerDown)
    }
}
#[doc = "Writes to this bit in PDRUNCFG, but not PDSLEEPCFG, can be disabled by an OTP bit.\n\nValue on reset: 1"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
...
#[doc = "Field `FBB_PD` reader - Writes to this bit in PDRUNCFG, but not PDSLEEPCFG, can be disabled by an OTP bit."]
pub type FbbPdR = crate::BitReader<FbbPd>;
impl FbbPdR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> FbbPd {
        match self.bits {
            false => FbbPd::Enabled,
            true => FbbPd::PowerDown,
        }
    }
    #[doc = "enabled"]
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn is_power_down(&self) -> bool {
        *self == FbbPd::PowerDown
    }
}
#[doc = "Field `FBB_PD` writer - Writes to this bit in PDRUNCFG, but not PDSLEEPCFG, can be disabled by an OTP bit."]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(FbbPd::Enabled)
    }
    #[doc = "power down"]
    #[inline(always)]
    pub fn power_down(self) -> &'a mut crate::W<REG> {
        self.variant(FbbPd::PowerDown)
    }
}
#[doc = "no description available\n\nValue on reset: 1"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
...
#[doc = "Field `HSPAD0_VDET_LP` reader - no description available"]
...
#[doc = "Field `HSPAD0_REF_PD` reader - no description available"]
...
#[doc = "Field `HSPAD2_VDET_LP` reader - no description available"]
...
#[doc = "Field `HSPAD2_REF_PD` reader - no description available"]
...
impl R {
    ...
    #[inline(always)]
    pub fn mainclk_shutoff(&self) -> MainclkShutoffR {
        MainclkShutoffR::new((self.bits & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn deep_pd(&self) -> DeepPdR {
        DeepPdR::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    #[doc = "Bit 11 - Writes to this bit in PDRUNCFG, but not PDSLEEPCFG, can be disabled by an OTP bit."]
    #[inline(always)]
    pub fn rbb_pd(&self) -> RbbPdR {
        RbbPdR::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - Writes to this bit in PDRUNCFG, but not PDSLEEPCFG, can be disabled by an OTP bit."]
    #[inline(always)]
    pub fn fbb_pd(&self) -> FbbPdR {
        FbbPdR::new(((self.bits >> 12) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mainclk_shutoff(&mut self) -> MainclkShutoffW<Pdsleepcfg0Spec> {
        MainclkShutoffW::new(self, 0)
    }
    #[doc = "Bit 1 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn pmic_mode0(&mut self) -> PmicMode0W<Pdsleepcfg0Spec> {
        PmicMode0W::new(self, 1)
    }
    #[doc = "Bit 2 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn pmic_mode1(&mut self) -> PmicMode1W<Pdsleepcfg0Spec> {
        PmicMode1W::new(self, 2)
    }
    #[doc = "Bit 3 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn deep_pd(&mut self) -> DeepPdW<Pdsleepcfg0Spec> {
        DeepPdW::new(self, 3)
    }
    #[doc = "Bit 4 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn vddcorereg_lp(&mut self) -> VddcoreregLpW<Pdsleepcfg0Spec> {
        VddcoreregLpW::new(self, 4)
    }
    #[doc = "Bit 6 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn pmcref_lp(&mut self) -> PmcrefLpW<Pdsleepcfg0Spec> {
        PmcrefLpW::new(self, 6)
    }
    #[doc = "Bit 7 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn hvd1v8_pd(&mut self) -> Hvd1v8PdW<Pdsleepcfg0Spec> {
        Hvd1v8PdW::new(self, 7)
    }
    #[doc = "Bit 8 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn porcore_lp(&mut self) -> PorcoreLpW<Pdsleepcfg0Spec> {
        PorcoreLpW::new(self, 8)
    }
    #[doc = "Bit 9 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn lvdcore_lp(&mut self) -> LvdcoreLpW<Pdsleepcfg0Spec> {
        LvdcoreLpW::new(self, 9)
    }
    #[doc = "Bit 10 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn hvdcore_pd(&mut self) -> HvdcorePdW<Pdsleepcfg0Spec> {
        HvdcorePdW::new(self, 10)
    }
    #[doc = "Bit 11 - Writes to this bit in PDRUNCFG, but not PDSLEEPCFG, can be disabled by an OTP bit."]
    #[inline(always)]
    #[must_use]
    pub fn rbb_pd(&mut self) -> RbbPdW<Pdsleepcfg0Spec> {
        RbbPdW::new(self, 11)
    }
    #[doc = "Bit 12 - Writes to this bit in PDRUNCFG, but not PDSLEEPCFG, can be disabled by an OTP bit."]
    #[inline(always)]
    #[must_use]
    pub fn fbb_pd(&mut self) -> FbbPdW<Pdsleepcfg0Spec> {
        FbbPdW::new(self, 12)
    }
    #[doc = "Bit 13 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn sysxtal_pd(&mut self) -> SysxtalPdW<Pdsleepcfg0Spec> {
        SysxtalPdW::new(self, 13)
    }
    #[doc = "Bit 14 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn lposc_pd(&mut self) -> LposcPdW<Pdsleepcfg0Spec> {
        LposcPdW::new(self, 14)
    }
    #[doc = "Bit 15 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn sfro_pd(&mut self) -> SfroPdW<Pdsleepcfg0Spec> {
        SfroPdW::new(self, 15)
    }
    #[doc = "Bit 16 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn ffro_pd(&mut self) -> FfroPdW<Pdsleepcfg0Spec> {
        FfroPdW::new(self, 16)
    }
    #[doc = "Bit 17 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn syspllldo_pd(&mut self) -> SyspllldoPdW<Pdsleepcfg0Spec> {
        SyspllldoPdW::new(self, 17)
    }
    #[doc = "Bit 18 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn syspllana_pd(&mut self) -> SyspllanaPdW<Pdsleepcfg0Spec> {
        SyspllanaPdW::new(self, 18)
    }
    #[doc = "Bit 19 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn audpllldo_pd(&mut self) -> AudpllldoPdW<Pdsleepcfg0Spec> {
        AudpllldoPdW::new(self, 19)
    }
    #[doc = "Bit 20 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn audpllana_pd(&mut self) -> AudpllanaPdW<Pdsleepcfg0Spec> {
        AudpllanaPdW::new(self, 20)
    }
    #[doc = "Bit 21 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn adc_pd(&mut self) -> AdcPdW<Pdsleepcfg0Spec> {
        AdcPdW::new(self, 21)
    }
    #[doc = "Bit 22 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn adc_lp(&mut self) -> AdcLpW<Pdsleepcfg0Spec> {
        AdcLpW::new(self, 22)
    }
    #[doc = "Bit 23 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn adctempsns_pd(&mut self) -> AdctempsnsPdW<Pdsleepcfg0Spec> {
        AdctempsnsPdW::new(self, 23)
    }
    #[doc = "Bit 25 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn acmp_pd(&mut self) -> AcmpPdW<Pdsleepcfg0Spec> {
        AcmpPdW::new(self, 25)
    }
    #[doc = "Bit 26 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn hspad0_vdet_lp(&mut self) -> Hspad0VdetLpW<Pdsleepcfg0Spec> {
        Hspad0VdetLpW::new(self, 26)
    }
    #[doc = "Bit 27 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn hspad0_ref_pd(&mut self) -> Hspad0RefPdW<Pdsleepcfg0Spec> {
        Hspad0RefPdW::new(self, 27)
    }
    #[doc = "Bit 28 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn hspad2_vdet_lp(&mut self) -> Hspad2VdetLpW<Pdsleepcfg0Spec> {
        Hspad2VdetLpW::new(self, 28)
    }
    #[doc = "Bit 29 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn hspad2_ref_pd(&mut self) -> Hspad2RefPdW<Pdsleepcfg0Spec> {
        Hspad2RefPdW::new(self, 29)
    }
}
#[doc = "Sleep configuration 0\n\nYou can [`read`](crate::Reg::read) this register and get [`pdsleepcfg0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pdsleepcfg0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pdsleepcfg0Spec;
impl crate::RegisterSpec for Pdsleepcfg0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pdsleepcfg0::R`](R) reader structure"]
impl crate::Readable for Pdsleepcfg0Spec {}
#[doc = "`write(|w| ..)` method takes [`pdsleepcfg0::W`](W) writer structure"]
impl crate::Writable for Pdsleepcfg0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PDSLEEPCFG0 to value 0x03fe_bc80"]
impl crate::Resettable for Pdsleepcfg0Spec {
