#[doc = "Register `DSP_SRAM_ACCESS_DISABLE` reader"]
pub type R = crate::R<DspSramAccessDisableSpec>;
...
#[doc = "DSP SRAM access disable\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dsp_sram_access_disable::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dsp_sram_access_disable::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DspSramAccessDisableSpec;
impl crate::RegisterSpec for DspSramAccessDisableSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dsp_sram_access_disable::R`](R) reader structure"]
impl crate::Readable for DspSramAccessDisableSpec {}
#[doc = "`write(|w| ..)` method takes [`dsp_sram_access_disable::W`](W) writer structure"]
impl crate::Writable for DspSramAccessDisableSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DSP_SRAM_ACCESS_DISABLE to value 0"]
impl crate::Resettable for DspSramAccessDisableSpec {
