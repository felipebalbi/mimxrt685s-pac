...
pub type R = crate::R<Pdruncfg1Spec>;
...
#[doc = "Run configuration 1\n\nYou can [`read`](crate::Reg::read) this register and get [`pdruncfg1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pdruncfg1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pdruncfg1Spec;
impl crate::RegisterSpec for Pdruncfg1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pdruncfg1::R`](R) reader structure"]
impl crate::Readable for Pdruncfg1Spec {}
#[doc = "`write(|w| ..)` method takes [`pdruncfg1::W`](W) writer structure"]
impl crate::Writable for Pdruncfg1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PDRUNCFG1 to value 0x0fff_ffff"]
impl crate::Resettable for Pdruncfg1Spec {
