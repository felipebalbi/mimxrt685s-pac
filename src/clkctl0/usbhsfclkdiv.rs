#[doc = "Register `USBHSFCLKDIV` reader"]
pub type R = crate::R<UsbhsfclkdivSpec>;
#[doc = "Register `USBHSFCLKDIV` writer"]
pub type W = crate::W<UsbhsfclkdivSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn div(&mut self) -> DivW<UsbhsfclkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Resets the divider counter. Can be used to make sure a new divider value is used right away rather than completing the previous count."]
    #[inline(always)]
    #[must_use]
    pub fn reset(&mut self) -> ResetW<UsbhsfclkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halts the divider counter. The intent is to allow the divider clock source to be changed without the risk of a glitch at the output."]
    #[inline(always)]
    #[must_use]
    pub fn halt(&mut self) -> HaltW<UsbhsfclkdivSpec> {
        HaltW::new(self, 30)
    }
    #[doc = "Bit 31 - Divider status flag. Set when a change is made to the divider value, cleared when the change is complete."]
    #[inline(always)]
    #[must_use]
    pub fn reqflag(&mut self) -> ReqflagW<UsbhsfclkdivSpec> {
        ReqflagW::new(self, 31)
    }
}
#[doc = "USBHS Fclk divider\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`usbhsfclkdiv::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`usbhsfclkdiv::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct UsbhsfclkdivSpec;
impl crate::RegisterSpec for UsbhsfclkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usbhsfclkdiv::R`](R) reader structure"]
impl crate::Readable for UsbhsfclkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`usbhsfclkdiv::W`](W) writer structure"]
impl crate::Writable for UsbhsfclkdivSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets USBHSFCLKDIV to value 0x4000_0000"]
impl crate::Resettable for UsbhsfclkdivSpec {
