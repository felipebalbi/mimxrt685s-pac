#[doc = "Register `SYSPLL0PFD` reader"]
pub type R = crate::R<Syspll0pfdSpec>;
#[doc = "Register `SYSPLL0PFD` writer"]
pub type W = crate::W<Syspll0pfdSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pfd0(&mut self) -> Pfd0W<Syspll0pfdSpec> {
        Pfd0W::new(self, 0)
    }
    #[doc = "Bit 6 - PFD0 Clock Ready Status Flag: Read as '1' clock ready. Cleared by writing a '1'."]
    #[inline(always)]
    #[must_use]
    pub fn pfd0_clkrdy(&mut self) -> Pfd0ClkrdyW<Syspll0pfdSpec> {
        Pfd0ClkrdyW::new(self, 6)
    }
    #[doc = "Bit 7 - PFD0 Clock Gate: 0: PFD0 clock is not gated. 1: PFD0 clock is gated"]
    #[inline(always)]
    #[must_use]
    pub fn pfd0_clkgate(&mut self) -> Pfd0ClkgateW<Syspll0pfdSpec> {
        Pfd0ClkgateW::new(self, 7)
    }
    #[doc = "Bits 8:13 - PLL Fractional Divider 1: Controls the fractional divider value. Valid PFD values are decimal 12-35."]
    #[inline(always)]
    #[must_use]
    pub fn pfd1(&mut self) -> Pfd1W<Syspll0pfdSpec> {
        Pfd1W::new(self, 8)
    }
    #[doc = "Bit 14 - PFD1 Clock Ready Status Flag: Read as '1' clock ready. Cleared by writing a '1'."]
    #[inline(always)]
    #[must_use]
    pub fn pfd1_clkrdy(&mut self) -> Pfd1ClkrdyW<Syspll0pfdSpec> {
        Pfd1ClkrdyW::new(self, 14)
    }
    #[doc = "Bit 15 - PFD1 Clock Gate: 0: PFD1 clock is not gated. 1: PFD1 clock is gated."]
    #[inline(always)]
    #[must_use]
    pub fn pfd1_clkgate(&mut self) -> Pfd1ClkgateW<Syspll0pfdSpec> {
        Pfd1ClkgateW::new(self, 15)
    }
    #[doc = "Bits 16:21 - PLL Fractional Divider 2: Controls the fractional divider value. Valid PFD values are decimal 12-35."]
    #[inline(always)]
    #[must_use]
    pub fn pfd2(&mut self) -> Pfd2W<Syspll0pfdSpec> {
        Pfd2W::new(self, 16)
    }
    #[doc = "Bit 22 - PFD2 Clock Ready Status Flag: Read as '1' clock ready. Cleared by writing a '1'."]
    #[inline(always)]
    #[must_use]
    pub fn pfd2_clkrdy(&mut self) -> Pfd2ClkrdyW<Syspll0pfdSpec> {
        Pfd2ClkrdyW::new(self, 22)
    }
    #[doc = "Bit 23 - PFD2 Clock Gate: 0: PFD2 clock is not gated. 1: PFD2 clock is gated."]
    #[inline(always)]
    #[must_use]
    pub fn pfd2_clkgate(&mut self) -> Pfd2ClkgateW<Syspll0pfdSpec> {
        Pfd2ClkgateW::new(self, 23)
    }
    #[doc = "Bits 24:29 - PLL Fractional Divider 3: Controls the fractional divider value. Valid PFD values are decimal 12-35."]
    #[inline(always)]
    #[must_use]
    pub fn pfd3(&mut self) -> Pfd3W<Syspll0pfdSpec> {
        Pfd3W::new(self, 24)
    }
    #[doc = "Bit 30 - PFD3 Clock Ready Status Flag: Read as '1' clock ready. Cleared by writing a '1'."]
    #[inline(always)]
    #[must_use]
    pub fn pfd3_clkrdy(&mut self) -> Pfd3ClkrdyW<Syspll0pfdSpec> {
        Pfd3ClkrdyW::new(self, 30)
    }
    #[doc = "Bit 31 - PFD3 Clock Gate: 0: PFD3 clock is not gated. 1: PFD3 clock is gated."]
    #[inline(always)]
    #[must_use]
    pub fn pfd3_clkgate(&mut self) -> Pfd3ClkgateW<Syspll0pfdSpec> {
        Pfd3ClkgateW::new(self, 31)
    }
}
#[doc = "sys pll0 PFD\n\nYou can [`read`](crate::Reg::read) this register and get [`syspll0pfd::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`syspll0pfd::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Syspll0pfdSpec;
impl crate::RegisterSpec for Syspll0pfdSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`syspll0pfd::R`](R) reader structure"]
impl crate::Readable for Syspll0pfdSpec {}
#[doc = "`write(|w| ..)` method takes [`syspll0pfd::W`](W) writer structure"]
impl crate::Writable for Syspll0pfdSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SYSPLL0PFD to value 0x8080_8080"]
impl crate::Resettable for Syspll0pfdSpec {
