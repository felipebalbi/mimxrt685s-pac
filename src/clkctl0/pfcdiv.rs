#[doc = "Register `PFCDIV%s` reader"]
pub type R = crate::R<PfcdivSpec>;
#[doc = "Register `PFCDIV%s` writer"]
pub type W = crate::W<PfcdivSpec>;
...
impl W {
    #[doc = "Bits 0:7 - Clock Divider Value Selection. . . 0: Divide by 1. ... 255: Divide by 256."]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<PfcdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Resets the divider counter. Can be used to make sure a new divider value is used right away rather than completing the previous count."]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<PfcdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halts the divider counter. The intent is to allow the divider clock source to be changed without the risk of a glitch at the output."]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<PfcdivSpec> {
        HaltW::new(self, 30)
    }
    #[doc = "Bit 31 - Divider status flag. Set when a change is made to the divider value, cleared when the change is complete."]
    #[inline(always)]
    pub fn reqflag(&mut self) -> ReqflagW<PfcdivSpec> {
        ReqflagW::new(self, 31)
    }
}
#[doc = "PFC divider register N\n\nYou can [`read`](crate::Reg::read) this register and get [`pfcdiv::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pfcdiv::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PfcdivSpec;
impl crate::RegisterSpec for PfcdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pfcdiv::R`](R) reader structure"]
impl crate::Readable for PfcdivSpec {}
#[doc = "`write(|w| ..)` method takes [`pfcdiv::W`](W) writer structure"]
impl crate::Writable for PfcdivSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PFCDIV%s to value 0x4000_0000"]
impl crate::Resettable for PfcdivSpec {
